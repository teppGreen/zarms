...
var _PostgreSQLLexerBase2 = _interopRequireWildcard(require("../../ASTGeneration/postgres/PostgreSQLLexerBase.js"));
...
var PostgreSQLLexer = exports["default"] = /*#__PURE__*/function (_PostgreSQLLexerBase) {
  function PostgreSQLLexer(input) {
    var _this;
    _classCallCheck(this, PostgreSQLLexer);
    _this = _callSuper(this, PostgreSQLLexer, [input]);
...
PostgreSQLLexer.MATCHED = 250;
PostgreSQLLexer.MATERIALIZED = 251;
PostgreSQLLexer.MAXVALUE = 252;
PostgreSQLLexer.MERGE = 253;
PostgreSQLLexer.MINUTE_P = 254;
PostgreSQLLexer.MINVALUE = 255;
PostgreSQLLexer.MODE = 256;
PostgreSQLLexer.MONTH_P = 257;
PostgreSQLLexer.MOVE = 258;
PostgreSQLLexer.NAME_P = 259;
PostgreSQLLexer.NAMES = 260;
PostgreSQLLexer.NEXT = 261;
PostgreSQLLexer.NO = 262;
PostgreSQLLexer.NOTHING = 263;
PostgreSQLLexer.NOTIFY = 264;
PostgreSQLLexer.NOWAIT = 265;
PostgreSQLLexer.NULLS_P = 266;
PostgreSQLLexer.OBJECT_P = 267;
PostgreSQLLexer.OF = 268;
PostgreSQLLexer.OFF = 269;
PostgreSQLLexer.OIDS = 270;
PostgreSQLLexer.OPERATOR = 271;
PostgreSQLLexer.OPTION = 272;
PostgreSQLLexer.OPTIONS = 273;
PostgreSQLLexer.OWNED = 274;
PostgreSQLLexer.OWNER = 275;
PostgreSQLLexer.PARSER = 276;
PostgreSQLLexer.PARTIAL = 277;
PostgreSQLLexer.PARTITION = 278;
PostgreSQLLexer.PASSING = 279;
PostgreSQLLexer.PASSWORD = 280;
PostgreSQLLexer.PLANS = 281;
PostgreSQLLexer.PRECEDING = 282;
PostgreSQLLexer.PREPARE = 283;
PostgreSQLLexer.PREPARED = 284;
PostgreSQLLexer.PRESERVE = 285;
PostgreSQLLexer.PRIOR = 286;
PostgreSQLLexer.PRIVILEGES = 287;
PostgreSQLLexer.PROCEDURAL = 288;
PostgreSQLLexer.PROCEDURE = 289;
PostgreSQLLexer.PROGRAM = 290;
PostgreSQLLexer.QUOTE = 291;
PostgreSQLLexer.RANGE = 292;
PostgreSQLLexer.READ = 293;
PostgreSQLLexer.REASSIGN = 294;
PostgreSQLLexer.RECHECK = 295;
PostgreSQLLexer.RECURSIVE = 296;
PostgreSQLLexer.REF = 297;
PostgreSQLLexer.REFRESH = 298;
PostgreSQLLexer.REINDEX = 299;
PostgreSQLLexer.RELATIVE_P = 300;
PostgreSQLLexer.RELEASE = 301;
PostgreSQLLexer.RENAME = 302;
PostgreSQLLexer.REPEATABLE = 303;
PostgreSQLLexer.REPLACE = 304;
PostgreSQLLexer.REPLICA = 305;
PostgreSQLLexer.RESET = 306;
PostgreSQLLexer.RESTART = 307;
PostgreSQLLexer.RESTRICT = 308;
PostgreSQLLexer.RETURNS = 309;
PostgreSQLLexer.REVOKE = 310;
PostgreSQLLexer.ROLE = 311;
PostgreSQLLexer.ROLLBACK = 312;
PostgreSQLLexer.ROWS = 313;
PostgreSQLLexer.RULE = 314;
PostgreSQLLexer.SAVEPOINT = 315;
PostgreSQLLexer.SCHEMA = 316;
PostgreSQLLexer.SCROLL = 317;
PostgreSQLLexer.SEARCH = 318;
PostgreSQLLexer.SECOND_P = 319;
PostgreSQLLexer.SECURITY = 320;
PostgreSQLLexer.SEQUENCE = 321;
PostgreSQLLexer.SEQUENCES = 322;
PostgreSQLLexer.SERIALIZABLE = 323;
PostgreSQLLexer.SERVER = 324;
PostgreSQLLexer.SESSION = 325;
PostgreSQLLexer.SET = 326;
PostgreSQLLexer.SHARE = 327;
PostgreSQLLexer.SHOW = 328;
PostgreSQLLexer.SIMPLE = 329;
PostgreSQLLexer.SNAPSHOT = 330;
PostgreSQLLexer.STABLE = 331;
PostgreSQLLexer.STANDALONE_P = 332;
PostgreSQLLexer.START = 333;
PostgreSQLLexer.STATEMENT = 334;
PostgreSQLLexer.STATISTICS = 335;
PostgreSQLLexer.STDIN = 336;
PostgreSQLLexer.STDOUT = 337;
PostgreSQLLexer.STORAGE = 338;
PostgreSQLLexer.STRICT_P = 339;
PostgreSQLLexer.STRIP_P = 340;
PostgreSQLLexer.SYSID = 341;
PostgreSQLLexer.SYSTEM_P = 342;
PostgreSQLLexer.TABLES = 343;
PostgreSQLLexer.TABLESPACE = 344;
PostgreSQLLexer.TEMP = 345;
PostgreSQLLexer.TEMPLATE = 346;
PostgreSQLLexer.TEMPORARY = 347;
PostgreSQLLexer.TEXT_P = 348;
PostgreSQLLexer.TRANSACTION = 349;
PostgreSQLLexer.TRIGGER = 350;
PostgreSQLLexer.TRUNCATE = 351;
PostgreSQLLexer.TRUSTED = 352;
PostgreSQLLexer.TYPE_P = 353;
PostgreSQLLexer.TYPES_P = 354;
PostgreSQLLexer.UNBOUNDED = 355;
PostgreSQLLexer.UNCOMMITTED = 356;
PostgreSQLLexer.UNENCRYPTED = 357;
PostgreSQLLexer.UNKNOWN = 358;
PostgreSQLLexer.UNLISTEN = 359;
PostgreSQLLexer.UNLOGGED = 360;
PostgreSQLLexer.UNTIL = 361;
PostgreSQLLexer.UPDATE = 362;
PostgreSQLLexer.VACUUM = 363;
PostgreSQLLexer.VALID = 364;
PostgreSQLLexer.VALIDATE = 365;
PostgreSQLLexer.VALIDATOR = 366;
PostgreSQLLexer.VARYING = 367;
PostgreSQLLexer.VERSION_P = 368;
PostgreSQLLexer.VIEW = 369;
PostgreSQLLexer.VOLATILE = 370;
PostgreSQLLexer.WHITESPACE_P = 371;
PostgreSQLLexer.WITHOUT = 372;
PostgreSQLLexer.WORK = 373;
PostgreSQLLexer.WRAPPER = 374;
PostgreSQLLexer.WRITE = 375;
PostgreSQLLexer.XML_P = 376;
PostgreSQLLexer.YEAR_P = 377;
PostgreSQLLexer.YES_P = 378;
PostgreSQLLexer.ZONE = 379;
PostgreSQLLexer.BETWEEN = 380;
PostgreSQLLexer.BIGINT = 381;
PostgreSQLLexer.BIT = 382;
PostgreSQLLexer.BOOLEAN_P = 383;
PostgreSQLLexer.CHAR_P = 384;
PostgreSQLLexer.CHARACTER = 385;
PostgreSQLLexer.COALESCE = 386;
PostgreSQLLexer.DEC = 387;
PostgreSQLLexer.DECIMAL_P = 388;
PostgreSQLLexer.EXISTS = 389;
PostgreSQLLexer.EXTRACT = 390;
PostgreSQLLexer.FLOAT_P = 391;
PostgreSQLLexer.GREATEST = 392;
PostgreSQLLexer.INOUT = 393;
PostgreSQLLexer.INT_P = 394;
PostgreSQLLexer.INTEGER = 395;
PostgreSQLLexer.INTERVAL = 396;
PostgreSQLLexer.LEAST = 397;
PostgreSQLLexer.NATIONAL = 398;
PostgreSQLLexer.NCHAR = 399;
PostgreSQLLexer.NONE = 400;
PostgreSQLLexer.NULLIF = 401;
PostgreSQLLexer.NUMERIC = 402;
PostgreSQLLexer.OVERLAY = 403;
PostgreSQLLexer.POSITION = 404;
PostgreSQLLexer.PRECISION = 405;
PostgreSQLLexer.REAL = 406;
PostgreSQLLexer.ROW = 407;
PostgreSQLLexer.SETOF = 408;
PostgreSQLLexer.SMALLINT = 409;
PostgreSQLLexer.SUBSTRING = 410;
PostgreSQLLexer.TIME = 411;
PostgreSQLLexer.TIMESTAMP = 412;
PostgreSQLLexer.TREAT = 413;
PostgreSQLLexer.TRIM = 414;
PostgreSQLLexer.VALUES = 415;
PostgreSQLLexer.VARCHAR = 416;
PostgreSQLLexer.XMLATTRIBUTES = 417;
PostgreSQLLexer.XMLCOMMENT = 418;
PostgreSQLLexer.XMLAGG = 419;
PostgreSQLLexer.XML_IS_WELL_FORMED = 420;
PostgreSQLLexer.XML_IS_WELL_FORMED_DOCUMENT = 421;
PostgreSQLLexer.XML_IS_WELL_FORMED_CONTENT = 422;
PostgreSQLLexer.XPATH = 423;
PostgreSQLLexer.XPATH_EXISTS = 424;
PostgreSQLLexer.XMLCONCAT = 425;
PostgreSQLLexer.XMLELEMENT = 426;
PostgreSQLLexer.XMLEXISTS = 427;
PostgreSQLLexer.XMLFOREST = 428;
PostgreSQLLexer.XMLPARSE = 429;
PostgreSQLLexer.XMLPI = 430;
PostgreSQLLexer.XMLROOT = 431;
PostgreSQLLexer.XMLSERIALIZE = 432;
PostgreSQLLexer.CALL = 433;
PostgreSQLLexer.CURRENT_P = 434;
PostgreSQLLexer.ATTACH = 435;
PostgreSQLLexer.DETACH = 436;
PostgreSQLLexer.EXPRESSION = 437;
PostgreSQLLexer.GENERATED = 438;
PostgreSQLLexer.LOGGED = 439;
PostgreSQLLexer.STORED = 440;
PostgreSQLLexer.INCLUDE = 441;
PostgreSQLLexer.ROUTINE = 442;
PostgreSQLLexer.TRANSFORM = 443;
PostgreSQLLexer.IMPORT_P = 444;
PostgreSQLLexer.POLICY = 445;
PostgreSQLLexer.METHOD = 446;
PostgreSQLLexer.REFERENCING = 447;
PostgreSQLLexer.NEW = 448;
PostgreSQLLexer.OLD = 449;
PostgreSQLLexer.VALUE_P = 450;
PostgreSQLLexer.SUBSCRIPTION = 451;
PostgreSQLLexer.PUBLICATION = 452;
PostgreSQLLexer.OUT_P = 453;
PostgreSQLLexer.END_P = 454;
PostgreSQLLexer.ROUTINES = 455;
PostgreSQLLexer.SCHEMAS = 456;
PostgreSQLLexer.PROCEDURES = 457;
PostgreSQLLexer.INPUT_P = 458;
PostgreSQLLexer.SUPPORT = 459;
PostgreSQLLexer.PARALLEL = 460;
PostgreSQLLexer.SQL_P = 461;
PostgreSQLLexer.DEPENDS = 462;
PostgreSQLLexer.OVERRIDING = 463;
PostgreSQLLexer.CONFLICT = 464;
PostgreSQLLexer.SKIP_P = 465;
PostgreSQLLexer.LOCKED = 466;
PostgreSQLLexer.TIES = 467;
PostgreSQLLexer.ROLLUP = 468;
PostgreSQLLexer.CUBE = 469;
PostgreSQLLexer.GROUPING = 470;
PostgreSQLLexer.SETS = 471;
PostgreSQLLexer.TABLESAMPLE = 472;
PostgreSQLLexer.ORDINALITY = 473;
PostgreSQLLexer.XMLTABLE = 474;
PostgreSQLLexer.COLUMNS = 475;
PostgreSQLLexer.XMLNAMESPACES = 476;
PostgreSQLLexer.ROWTYPE = 477;
PostgreSQLLexer.NORMALIZED = 478;
PostgreSQLLexer.WITHIN = 479;
PostgreSQLLexer.FILTER = 480;
PostgreSQLLexer.GROUPS = 481;
PostgreSQLLexer.OTHERS = 482;
PostgreSQLLexer.NFC = 483;
PostgreSQLLexer.NFD = 484;
PostgreSQLLexer.NFKC = 485;
PostgreSQLLexer.NFKD = 486;
PostgreSQLLexer.UESCAPE = 487;
PostgreSQLLexer.VIEWS = 488;
PostgreSQLLexer.NORMALIZE = 489;
PostgreSQLLexer.DUMP = 490;
PostgreSQLLexer.PRINT_STRICT_PARAMS = 491;
PostgreSQLLexer.VARIABLE_CONFLICT = 492;
PostgreSQLLexer.ERROR = 493;
PostgreSQLLexer.USE_VARIABLE = 494;
PostgreSQLLexer.USE_COLUMN = 495;
PostgreSQLLexer.ALIAS = 496;
PostgreSQLLexer.CONSTANT = 497;
PostgreSQLLexer.PERFORM = 498;
PostgreSQLLexer.GET = 499;
PostgreSQLLexer.DIAGNOSTICS = 500;
PostgreSQLLexer.STACKED = 501;
PostgreSQLLexer.ELSIF = 502;
PostgreSQLLexer.WHILE = 503;
PostgreSQLLexer.REVERSE = 504;
PostgreSQLLexer.FOREACH = 505;
PostgreSQLLexer.SLICE = 506;
PostgreSQLLexer.EXIT = 507;
PostgreSQLLexer.RETURN = 508;
PostgreSQLLexer.QUERY = 509;
PostgreSQLLexer.RAISE = 510;
PostgreSQLLexer.SQLSTATE = 511;
PostgreSQLLexer.DEBUG = 512;
PostgreSQLLexer.LOG = 513;
PostgreSQLLexer.INFO = 514;
PostgreSQLLexer.NOTICE = 515;
PostgreSQLLexer.WARNING = 516;
PostgreSQLLexer.EXCEPTION = 517;
PostgreSQLLexer.ASSERT = 518;
PostgreSQLLexer.LOOP = 519;
PostgreSQLLexer.OPEN = 520;
PostgreSQLLexer.ABS = 521;
PostgreSQLLexer.CBRT = 522;
PostgreSQLLexer.CEIL = 523;
PostgreSQLLexer.CEILING = 524;
PostgreSQLLexer.DEGREES = 525;
PostgreSQLLexer.DIV = 526;
PostgreSQLLexer.EXP = 527;
PostgreSQLLexer.FACTORIAL = 528;
PostgreSQLLexer.FLOOR = 529;
PostgreSQLLexer.GCD = 530;
PostgreSQLLexer.LCM = 531;
PostgreSQLLexer.LN = 532;
PostgreSQLLexer.LOG10 = 533;
PostgreSQLLexer.MIN_SCALE = 534;
PostgreSQLLexer.MOD = 535;
PostgreSQLLexer.PI = 536;
PostgreSQLLexer.POWER = 537;
PostgreSQLLexer.RADIANS = 538;
PostgreSQLLexer.ROUND = 539;
PostgreSQLLexer.SCALE = 540;
PostgreSQLLexer.SIGN = 541;
PostgreSQLLexer.SQRT = 542;
PostgreSQLLexer.TRIM_SCALE = 543;
PostgreSQLLexer.TRUNC = 544;
PostgreSQLLexer.WIDTH_BUCKET = 545;
PostgreSQLLexer.RANDOM = 546;
PostgreSQLLexer.SETSEED = 547;
PostgreSQLLexer.ACOS = 548;
PostgreSQLLexer.ACOSD = 549;
PostgreSQLLexer.ASIN = 550;
PostgreSQLLexer.ASIND = 551;
PostgreSQLLexer.ATAN = 552;
PostgreSQLLexer.ATAND = 553;
PostgreSQLLexer.ATAN2 = 554;
PostgreSQLLexer.ATAN2D = 555;
PostgreSQLLexer.COS = 556;
PostgreSQLLexer.COSD = 557;
PostgreSQLLexer.COT = 558;
PostgreSQLLexer.COTD = 559;
PostgreSQLLexer.SIN = 560;
PostgreSQLLexer.SIND = 561;
PostgreSQLLexer.TAN = 562;
PostgreSQLLexer.TAND = 563;
PostgreSQLLexer.SINH = 564;
PostgreSQLLexer.COSH = 565;
PostgreSQLLexer.TANH = 566;
PostgreSQLLexer.ASINH = 567;
PostgreSQLLexer.ACOSH = 568;
PostgreSQLLexer.ATANH = 569;
PostgreSQLLexer.BIT_LENGTH = 570;
PostgreSQLLexer.CHAR_LENGTH = 571;
PostgreSQLLexer.CHARACTER_LENGTH = 572;
PostgreSQLLexer.LOWER = 573;
PostgreSQLLexer.OCTET_LENGTH = 574;
PostgreSQLLexer.UPPER = 575;
PostgreSQLLexer.ASCII = 576;
PostgreSQLLexer.BTRIM = 577;
PostgreSQLLexer.CHR = 578;
PostgreSQLLexer.CONCAT = 579;
PostgreSQLLexer.CONCAT_WS = 580;
PostgreSQLLexer.FORMAT = 581;
PostgreSQLLexer.INITCAP = 582;
PostgreSQLLexer.LENGTH = 583;
PostgreSQLLexer.LPAD = 584;
PostgreSQLLexer.LTRIM = 585;
PostgreSQLLexer.MD5 = 586;
PostgreSQLLexer.PARSE_IDENT = 587;
PostgreSQLLexer.PG_CLIENT_ENCODING = 588;
PostgreSQLLexer.QUOTE_IDENT = 589;
PostgreSQLLexer.QUOTE_LITERAL = 590;
PostgreSQLLexer.QUOTE_NULLABLE = 591;
PostgreSQLLexer.REGEXP_COUNT = 592;
PostgreSQLLexer.REGEXP_INSTR = 593;
PostgreSQLLexer.REGEXP_LIKE = 594;
PostgreSQLLexer.REGEXP_MATCH = 595;
PostgreSQLLexer.REGEXP_MATCHES = 596;
PostgreSQLLexer.REGEXP_REPLACE = 597;
PostgreSQLLexer.REGEXP_SPLIT_TO_ARRAY = 598;
PostgreSQLLexer.REGEXP_SPLIT_TO_TABLE = 599;
PostgreSQLLexer.REGEXP_SUBSTR = 600;
PostgreSQLLexer.REPEAT = 601;
PostgreSQLLexer.RPAD = 602;
PostgreSQLLexer.RTRIM = 603;
PostgreSQLLexer.SPLIT_PART = 604;
PostgreSQLLexer.STARTS_WITH = 605;
PostgreSQLLexer.STRING_TO_ARRAY = 606;
PostgreSQLLexer.STRING_TO_TABLE = 607;
PostgreSQLLexer.STRPOS = 608;
PostgreSQLLexer.SUBSTR = 609;
PostgreSQLLexer.TO_ASCII = 610;
PostgreSQLLexer.TO_HEX = 611;
PostgreSQLLexer.TRANSLATE = 612;
PostgreSQLLexer.UNISTR = 613;
PostgreSQLLexer.AGE = 614;
PostgreSQLLexer.CLOCK_TIMESTAMP = 615;
PostgreSQLLexer.DATE_BIN = 616;
PostgreSQLLexer.DATE_PART = 617;
PostgreSQLLexer.DATE_TRUNC = 618;
PostgreSQLLexer.ISFINITE = 619;
PostgreSQLLexer.JUSTIFY_DAYS = 620;
PostgreSQLLexer.JUSTIFY_HOURS = 621;
PostgreSQLLexer.JUSTIFY_INTERVAL = 622;
PostgreSQLLexer.MAKE_DATE = 623;
PostgreSQLLexer.MAKE_INTERVAL = 624;
PostgreSQLLexer.MAKE_TIME = 625;
PostgreSQLLexer.MAKE_TIMESTAMP = 626;
PostgreSQLLexer.MAKE_TIMESTAMPTZ = 627;
PostgreSQLLexer.NOW = 628;
PostgreSQLLexer.STATEMENT_TIMESTAMP = 629;
PostgreSQLLexer.TIMEOFDAY = 630;
PostgreSQLLexer.TRANSACTION_TIMESTAMP = 631;
PostgreSQLLexer.TO_TIMESTAMP = 632;
PostgreSQLLexer.TO_CHAR = 633;
PostgreSQLLexer.TO_DATE = 634;
PostgreSQLLexer.TO_NUMBER = 635;
PostgreSQLLexer.Identifier = 636;
PostgreSQLLexer.QuotedIdentifier = 637;
PostgreSQLLexer.UnterminatedQuotedIdentifier = 638;
PostgreSQLLexer.InvalidQuotedIdentifier = 639;
PostgreSQLLexer.InvalidUnterminatedQuotedIdentifier = 640;
PostgreSQLLexer.UnicodeQuotedIdentifier = 641;
PostgreSQLLexer.UnterminatedUnicodeQuotedIdentifier = 642;
PostgreSQLLexer.InvalidUnicodeQuotedIdentifier = 643;
PostgreSQLLexer.InvalidUnterminatedUnicodeQuotedIdentifier = 644;
PostgreSQLLexer.StringConstant = 645;
PostgreSQLLexer.UnterminatedStringConstant = 646;
PostgreSQLLexer.UnicodeEscapeStringConstant = 647;
PostgreSQLLexer.UnterminatedUnicodeEscapeStringConstant = 648;
PostgreSQLLexer.BeginDollarStringConstant = 649;
PostgreSQLLexer.BinaryStringConstant = 650;
PostgreSQLLexer.UnterminatedBinaryStringConstant = 651;
PostgreSQLLexer.InvalidBinaryStringConstant = 652;
PostgreSQLLexer.InvalidUnterminatedBinaryStringConstant = 653;
PostgreSQLLexer.HexadecimalStringConstant = 654;
PostgreSQLLexer.UnterminatedHexadecimalStringConstant = 655;
PostgreSQLLexer.InvalidHexadecimalStringConstant = 656;
PostgreSQLLexer.InvalidUnterminatedHexadecimalStringConstant = 657;
PostgreSQLLexer.Integral = 658;
PostgreSQLLexer.NumericFail = 659;
PostgreSQLLexer.Numeric = 660;
PostgreSQLLexer.PLSQLVARIABLENAME = 661;
PostgreSQLLexer.PLSQLIDENTIFIER = 662;
PostgreSQLLexer.Whitespace = 663;
PostgreSQLLexer.Newline = 664;
PostgreSQLLexer.LineComment = 665;
PostgreSQLLexer.BlockComment = 666;
PostgreSQLLexer.UnterminatedBlockComment = 667;
PostgreSQLLexer.MetaCommand = 668;
PostgreSQLLexer.EndMetaCommand = 669;
PostgreSQLLexer.ErrorCharacter = 670;
PostgreSQLLexer.EscapeStringConstant = 671;
PostgreSQLLexer.UnterminatedEscapeStringConstant = 672;
PostgreSQLLexer.InvalidEscapeStringConstant = 673;
PostgreSQLLexer.InvalidUnterminatedEscapeStringConstant = 674;
PostgreSQLLexer.AfterEscapeStringConstantMode_NotContinued = 675;
PostgreSQLLexer.AfterEscapeStringConstantWithNewlineMode_NotContinued = 676;
PostgreSQLLexer.DollarText = 677;
PostgreSQLLexer.EndDollarStringConstant = 678;
PostgreSQLLexer.AfterEscapeStringConstantWithNewlineMode_Continued = 679;
...
PostgreSQLLexer.prototype.action = function (localctx, ruleIndex, actionIndex) {
  switch (ruleIndex) {
    case 28:
...
PostgreSQLLexer.prototype.Operator_action = function (localctx, actionIndex) {
  switch (actionIndex) {
    case 0:
      (0, _PostgreSQLLexerBase2.HandleLessLessGreaterGreater)();
      break;
    default:
...
PostgreSQLLexer.prototype.BeginDollarStringConstant_action = function (localctx, actionIndex) {
  switch (actionIndex) {
    case 1:
      (0, _PostgreSQLLexerBase2.pushTag)();
      break;
    default:
      throw "No registered action for:" + actionIndex;
  }
...
PostgreSQLLexer.prototype.UnterminatedBlockComment_action = function (localctx, actionIndex) {
  switch (actionIndex) {
    case 3:
...
PostgreSQLLexer.prototype.AfterEscapeStringConstantMode_NotContinued_action = function (localctx, actionIndex) {
  switch (actionIndex) {
    case 4:
      break;
    default:
...
PostgreSQLLexer.prototype.AfterEscapeStringConstantWithNewlineMode_NotContinued_action = function (localctx, actionIndex) {
  switch (actionIndex) {
    case 5:
      break;
    default:
...
PostgreSQLLexer.prototype.sempred = function (localctx, ruleIndex, predIndex) {
  switch (ruleIndex) {
    case 28:
...
PostgreSQLLexer.prototype.Operator_sempred = function (localctx, predIndex) {
  switch (predIndex) {
    case 0:
      return (0, _PostgreSQLLexerBase2.checkLA)('-');
    case 1:
      return (0, _PostgreSQLLexerBase2.checkLA)('*');
    case 2:
      return (0, _PostgreSQLLexerBase2.checkLA)('*');
...
PostgreSQLLexer.prototype.EndDollarStringConstant_sempred = function (localctx, predIndex) {
  switch (predIndex) {
    case 8:
      return (0, _PostgreSQLLexerBase2.isTag)();
    default:
      throw "No predicate with index:" + predIndex;
  }
};