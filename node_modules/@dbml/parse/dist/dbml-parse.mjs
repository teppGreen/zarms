var Hn = typeof global == "object" && global && global.Object === Object && global, zr = typeof self == "object" && self && self.Object === Object && self, ge = Hn || zr || Function("return this")(), Ne = ge.Symbol, Kn = Object.prototype, Yr = Kn.hasOwnProperty, qr = Kn.toString, ze = Ne ? Ne.toStringTag : void 0;
function Qr(e) {
  var t = Yr.call(e, ze), n = e[ze];
  try {
    e[ze] = void 0;
    var r = !0;
  } catch {
  ...
  var s = qr.call(e);
  return r && (t ? e[ze] = n : delete e[ze]), s;
}
var Jr = Object.prototype, Zr = Jr.toString;
function es(e) {
  return Zr.call(e);
}
var ts = "[object Null]", ns = "[object Undefined]", sn = Ne ? Ne.toStringTag : void 0;
function Xe(e) {
  return e == null ? e === void 0 ? ns : ts : sn && sn in Object(e) ? Qr(e) : es(e);
}
function De(e) {
...
function dt(e) {
  return typeof e == "symbol" || De(e) && Xe(e) == rs;
}
function zn(e, t) {
...
var pe = Array.isArray, an = Ne ? Ne.prototype : void 0, on = an ? an.toString : void 0;
function Yn(e) {
  if (typeof e == "string")
    return e;
  if (pe(e))
...
var ln = NaN, ls = /^[-+]0x[0-9a-f]+$/i, cs = /^0b[01]+$/i, us = /^0o[0-7]+$/i, hs = parseInt;
function fs(e) {
  if (typeof e == "number")
    return e;
  if (dt(e))
  ...
  e = os(e);
  var n = cs.test(e);
  return n || us.test(e) ? hs(e.slice(2), n ? 2 : 8) : ls.test(e) ? ln : +e;
}
var cn = 1 / 0, ps = 17976931348623157e292;
function ds(e) {
  if (!e)
    return e === 0 ? e : 0;
  if (e = fs(e), e === cn || e === -cn) {
...
var Ns = "[object AsyncFunction]", Ts = "[object Function]", bs = "[object GeneratorFunction]", ms = "[object Proxy]";
function qn(e) {
  if (!Ge(e))
    return !1;
  var t = Xe(e);
  return t == Ts || t == bs || t == Ns || t == ms;
}
var wt = ge["__core-js_shared__"], un = function() {
...
var _s = Function.prototype, gs = _s.toString;
function Fe(e) {
  if (e != null) {
    try {
      return gs.call(e);
...
var As = /[\\^$.*+?()[\]{}|]/g, Ls = /^\[object .+?Constructor\]$/, vs = Function.prototype, ys = Object.prototype, ws = vs.toString, Ss = ys.hasOwnProperty, Ps = RegExp(
  "^" + ws.call(Ss).replace(As, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Os(e) {
  if (!Ge(e) || Is(e))
    return !1;
...
var Gs = 9007199254740991, $s = /^(?:0|[1-9]\d*)$/;
function Qn(e, t) {
  var n = typeof e;
  return t = t ?? Gs, !!t && (n == "number" || n != "symbol" && $s.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
function Jn(e, t) {
  return e === t || e !== e && t !== t;
}
...
function Xs(e, t, n) {
  return t = fn(t === void 0 ? e.length - 1 : t, 0), function() {
    for (var r = arguments, s = -1, i = fn(r.length - t, 0), a = Array(i); ++s < i; )
      a[s] = r[t + s];
    s = -1;
    for (var o = Array(t + 1); ++s < t; )
      o[s] = r[s];
    return o[t] = n(a), Ds(e, this, o);
  };
}
function js(e, t) {
  return Vs(Xs(e, t, Et), e + "");
}
...
function Nt(e) {
  return e != null && Vt(e.length) && !qn(e);
}
...
var tr = Object.prototype, zs = tr.hasOwnProperty, Ys = tr.propertyIsEnumerable, Ct = pn(/* @__PURE__ */ function() {
  return arguments;
}()) ? pn : function(e) {
  return De(e) && zs.call(e, "callee") && !Ys.call(e, "callee");
};
function qs() {
  return !1;
}
var nr = typeof exports == "object" && exports && !exports.nodeType && exports, dn = nr && typeof module == "object" && module && !module.nodeType && module, Qs = dn && dn.exports === nr, En = Qs ? ge.Buffer : void 0, Js = En ? En.isBuffer : void 0, xt = Js || qs, Zs = "[object Arguments]", ei = "[object Array]", ti = "[object Boolean]", ni = "[object Date]", ri = "[object Error]", si = "[object Function]", ii = "[object Map]", ai = "[object Number]", oi = "[object Object]", li = "[object RegExp]", ci = "[object Set]", ui = "[object String]", hi = "[object WeakMap]", fi = "[object ArrayBuffer]", pi = "[object DataView]", di = "[object Float32Array]", Ei = "[object Float64Array]", Ni = "[object Int8Array]", Ti = "[object Int16Array]", bi = "[object Int32Array]", mi = "[object Uint8Array]", Ii = "[object Uint8ClampedArray]", _i = "[object Uint16Array]", gi = "[object Uint32Array]", x = {};
x[di] = x[Ei] = x[Ni] = x[Ti] = x[bi] = x[mi] = x[Ii] = x[_i] = x[gi] = !0;
x[Zs] = x[ei] = x[fi] = x[ti] = x[pi] = x[ni] = x[ri] = x[si] = x[ii] = x[ai] = x[oi] = x[li] = x[ci] = x[ui] = x[hi] = !1;
function Ai(e) {
  return De(e) && Vt(e.length) && !!x[Xe(e)];
}
function Li(e) {
  return function(t) {
    return e(t);
...
var rr = typeof exports == "object" && exports && !exports.nodeType && exports, Ye = rr && typeof module == "object" && module && !module.nodeType && module, vi = Ye && Ye.exports === rr, St = vi && Hn.process, Nn = function() {
  try {
    var e = Ye && Ye.require && Ye.require("util").types;
    return e || St && St.binding && St.binding("util");
  } catch {
  }
}(), Tn = Nn && Nn.isTypedArray, sr = Tn ? Li(Tn) : Ai, yi = Object.prototype, wi = yi.hasOwnProperty;
function ir(e, t) {
  var n = pe(e), r = !n && Ct(e), s = !n && !r && xt(e), i = !n && !r && !s && sr(e), a = n || r || s || i, o = a ? er(e.length, String) : [], u = o.length;
  for (var p in e)
    (t || wi.call(e, p)) && !(a && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var Pi = Si(Object.keys, Object), Oi = Object.prototype, xi = Oi.hasOwnProperty;
function Di(e) {
  if (!Zn(e))
    return Pi(e);
  var t = [];
...
var Ri = Object.prototype, Ui = Ri.hasOwnProperty;
function Mi(e) {
  if (!Ge(e))
    return ki(e);
  var t = Zn(e), n = [];
  for (var r in e)
    r == "constructor" && (t || !Ui.call(e, r)) || n.push(r);
  return n;
}
function Fi(e) {
  return Nt(e) ? ir(e, !0) : Mi(e);
}
var Bi = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Vi = /^\w*$/;
function $t(e, t) {
  if (pe(e))
    return !1;
  var n = typeof e;
  return n == "number" || n == "symbol" || n == "boolean" || e == null || dt(e) ? !0 : Vi.test(e) || !Bi.test(e) || t != null && e in Object(t);
}
...
var $i = "__lodash_hash_undefined__", Xi = Object.prototype, ji = Xi.hasOwnProperty;
function Wi(e) {
  var t = this.__data__;
  if (Qe) {
    var n = t[e];
...
function zi(e) {
  var t = this.__data__;
  return Qe ? t[e] !== void 0 : Ki.call(t, e);
}
var Yi = "__lodash_hash_undefined__";
function qi(e, t) {
  var n = this.__data__;
  return this.size += this.has(e) ? 0 : 1, n[e] = Qe && t === void 0 ? Yi : t, this;
}
function ke(e) {
...
Ae.prototype.clear = Qi;
Ae.prototype.delete = ea;
Ae.prototype.get = ta;
Ae.prototype.has = na;
Ae.prototype.set = ra;
var Je = Be(ge, "Map");
...
function Xt(e, t) {
  ...
  return n.cache = new (Xt.Cache || Le)(), n;
}
Xt.Cache = Le;
var ha = 500;
function fa(e) {
...
var pa = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, da = /\\(\\)?/g, Ea = fa(function(e) {
  var t = [];
  return e.charCodeAt(0) === 46 && t.push(""), e.replace(pa, function(n, r, s, i) {
    t.push(s ? i.replace(da, "$1") : r || n);
  }), t;
});
function Na(e) {
  return e == null ? "" : Yn(e);
...
var bn = Ne ? Ne.isConcatSpreadable : void 0;
function Ta(e) {
  return pe(e) || Ct(e) || !!(bn && e && e[bn]);
}
function ba(e, t, n, r, s) {
  var i = -1, a = e.length;
  for (n || (n = Ta), s || (s = []); ++i < a; ) {
    var o = e[i];
    n(o) ? cr(s, o) : s[s.length] = o;
  }
  return s;
}
function mn(e) {
...
_e.prototype.clear = ma;
_e.prototype.delete = Ia;
_e.prototype.get = _a;
_e.prototype.has = ga;
_e.prototype.set = La;
function ur(e, t) {
...
var ya = Object.prototype, wa = ya.propertyIsEnumerable, In = Object.getOwnPropertySymbols, Sa = In ? function(e) {
  return e == null ? [] : (e = Object(e), ur(In(e), function(t) {
    return wa.call(e, t);
  }));
} : va;
function Pa(e, t, n) {
  var r = t(e);
  return pe(e) ? r : cr(r, n(e));
}
function _n(e) {
  return Pa(e, Gt, Sa);
}
var Dt = Be(ge, "DataView"), kt = Be(ge, "Promise"), Rt = Be(ge, "Set"), gn = "[object Map]", Oa = "[object Object]", An = "[object Promise]", Ln = "[object Set]", vn = "[object WeakMap]", yn = "[object DataView]", xa = Fe(Dt), Da = Fe(Je), ka = Fe(kt), Ra = Fe(Rt), Ua = Fe(Ot), Se = Xe;
(Dt && Se(new Dt(new ArrayBuffer(1))) != yn || Je && Se(new Je()) != gn || kt && Se(kt.resolve()) != An || Rt && Se(new Rt()) != Ln || Ot && Se(new Ot()) != vn) && (Se = function(e) {
  var t = Xe(e), n = t == Oa ? e.constructor : void 0, r = n ? Fe(n) : "";
  if (r)
    switch (r) {
      case xa:
        return yn;
...
var wn = ge.Uint8Array, Ma = "__lodash_hash_undefined__";
function Fa(e) {
...
ot.prototype.add = ot.prototype.push = Fa;
ot.prototype.has = Ba;
function Va(e, t) {
...
function hr(e, t, n, r, s, i) {
  ...
  if (p && h)
    return p == t && h == e;
  var d = -1, N = !0, b = n & $a ? new ot() : void 0;
  for (i.set(e, t), i.set(t, e); ++d < o; ) {
    ...
    if (b) {
      if (!Va(t, function(K, z) {
        if (!Ca(b, z) && (A === K || s(A, K, n, r, i)))
          return b.push(z);
      })) {
        N = !1;
        break;
...
var Wa = 1, Ha = 2, Ka = "[object Boolean]", za = "[object Date]", Ya = "[object Error]", qa = "[object Map]", Qa = "[object Number]", Ja = "[object RegExp]", Za = "[object Set]", eo = "[object String]", to = "[object Symbol]", no = "[object ArrayBuffer]", ro = "[object DataView]", Sn = Ne ? Ne.prototype : void 0, Pt = Sn ? Sn.valueOf : void 0;
function so(e, t, n, r, s, i, a) {
  switch (n) {
    case ro:
    ...
    case no:
      return !(e.byteLength != t.byteLength || !i(new wn(e), new wn(t)));
    case Ka:
    case za:
    case Qa:
      return Jn(+e, +t);
    ...
    case Za:
      var u = r & Wa;
      if (o || (o = ja), e.size != t.size && !u)
        return !1;
      var p = a.get(e);
      if (p)
        return p == t;
      r |= Ha, a.set(e, t);
      var h = hr(o(e), o(t), r, s, i, a);
      return a.delete(e), h;
    case to:
      if (Pt)
...
function lo(e, t, n, r, s, i) {
  var a = n & io, o = _n(e), u = o.length, p = _n(t), h = p.length;
  if (u != h && !a)
    return !1;
  for (var d = u; d--; ) {
    var N = o[d];
    if (!(a ? N in t : oo.call(t, N)))
      return !1;
  }
  ...
  for (var v = a; ++d < u; ) {
    ...
    var K = e[N], z = t[N];
    if (r)
      var w = a ? r(z, K, N, t, e, i) : r(K, z, N, e, t, i);
    if (!(w === void 0 ? K === z || s(K, z, n, r, i) : w)) {
      I = !1;
      break;
    }
    v || (v = N == "constructor");
  ...
  if (I && !v) {
    var J = e.constructor, G = t.constructor;
    J != G && "constructor" in e && "constructor" in t && !(typeof J == "function" && J instanceof J && typeof G == "function" && G instanceof G) && (I = !1);
  }
  return i.delete(e), i.delete(t), I;
}
var co = 1, Pn = "[object Arguments]", On = "[object Array]", rt = "[object Object]", uo = Object.prototype, xn = uo.hasOwnProperty;
function ho(e, t, n, r, s, i) {
  var a = pe(e), o = pe(t), u = a ? On : Se(e), p = o ? On : Se(t);
  u = u == Pn ? rt : u, p = p == Pn ? rt : p;
  var h = u == rt, d = p == rt, N = u == p;
  if (N && xt(e)) {
    if (!xt(t))
      return !1;
    a = !0, h = !1;
  ...
  if (N && !h)
    return i || (i = new _e()), a || sr(e) ? hr(e, t, n, r, s, i) : so(e, t, u, n, r, s, i);
  if (!(n & co)) {
    var b = h && xn.call(e, "__wrapped__"), A = d && xn.call(t, "__wrapped__");
    if (b || A) {
      var I = b ? e.value() : e, v = A ? t.value() : t;
      return i || (i = new _e()), s(I, v, n, r, i);
    }
  }
  return N ? (i || (i = new _e()), lo(e, t, n, r, s, i)) : !1;
}
function jt(e, t, n, r, s) {
  return e === t ? !0 : e == null || t == null || !De(e) && !De(t) ? e !== e && t !== t : ho(e, t, n, r, jt, s);
}
var fo = 1, po = 2;
function Eo(e, t, n, r) {
  var s = n.length, i = s;
  ...
  for (; ++s < i; ) {
    ...
    if (a[2]) {
      ...
      var h = new _e(), d;
      if (!(d === void 0 ? jt(p, u, fo | po, r, h) : d))
        return !1;
    }
  }
  return !0;
...
function To(e) {
  var t = No(e);
  return t.length == 1 && t[0][2] ? pr(t[0][0], t[0][1]) : function(n) {
    return n === e || Eo(n, e, t);
  };
}
function bo(e, t) {
...
function mo(e, t, n) {
  ...
  return i || ++r != s ? i : (s = e == null ? 0 : e.length, !!s && Vt(s) && Qn(a, s) && (pe(e) || Ct(e)));
}
function Io(e, t) {
  return e != null && mo(e, t, bo);
}
var _o = 1, go = 2;
function Ao(e, t) {
  return $t(e) && fr(t) ? pr(mt(e), t) : function(n) {
    var r = lr(n, e);
    return r === void 0 && r === t ? Io(n, e) : jt(t, r, _o | go);
  };
}
function dr(e) {
  return function(t) {
...
function vo(e) {
  return $t(e) ? dr(mt(e)) : Lo(e);
}
function Er(e) {
  return typeof e == "function" ? e : e == null ? Et : typeof e == "object" ? pe(e) ? Ao(e[0], e[1]) : To(e) : vo(e);
}
function yo(e, t, n, r) {
...
var Oo = Po(So);
function xo(e, t, n, r) {
  return Oo(e, function(s, i, a) {
    t(r, s, n(s), a);
  }), r;
}
function Do(e, t) {
  return function(n, r) {
    var s = pe(n) ? yo : xo, i = t ? t() : {};
    return s(n, e, Er(r), i);
  };
}
function ko(e) {
...
var Uo = Math.max, Mo = Math.min;
function Fo(e, t, n) {
  var r = e == null ? 0 : e.length;
  if (!r)
    return -1;
  var s = r - 1;
  return n !== void 0 && (s = Es(n), s = n < 0 ? Uo(r + s, 0) : Mo(s, r - 1)), Cs(e, Er(t), s);
}
function Bo(e) {
  return e && e.length ? e[0] : void 0;
}
function Ze(e, t) {
  return e == null ? e : Nr(e, Ro(t), Fi);
}
var oe = Do(function(e, t, n) {
  e[n ? 0 : 1].push(t);
}, function() {
  return [[], []];
}), Vo = Math.max;
...
function kn(e, t) {
  return t.leadingTrivia.find(({ kind: r }) => r === f.NEWLINE) !== void 0 || Tr(e);
}
function Mt(e) {
  return e.trailingTrivia.find(({ kind: t }) => [f.SPACE, f.TAB].includes(t)) !== void 0;
}
function br(e) {
  return e.trailingTrivia.length === 0 ? e.end : br(R(e.trailingTrivia));
}
function mr(e) {
  return e.leadingTrivia.length === 0 ? e.start : mr(e.leadingTrivia[0]);
}
function Xo(e) {
...
class U {
  ...
  constructor(t, n, r) {
    ...
    s ? (this.startPos = s.startPos, this.fullStart = s instanceof te ? mr(s) : s.fullStart) : (this.startPos = {
      offset: NaN,
      column: NaN,
      line: NaN
    }, this.fullStart = NaN);
    const i = [...r].reverse().find((a) => a !== void 0 && !Number.isNaN(a.end));
    i ? (this.endPos = i.endPos, this.fullEnd = i instanceof te ? br(i) : i.fullEnd) : (this.endPos = {
      offset: NaN,
      column: NaN,
      line: NaN
...
class P extends U {
  constructor({
    ...
    if (super(u, "<element-declaration>", [
      ...
      a,
      o
    ]), o && a && !(o instanceof y || o instanceof P))
...
class st extends U {
  constructor({ pre: t }, n) {
    const r = te.create(f.SPACE, t.endPos, t.endPos, " ", !1);
    super(n, "<dummy>", [r]);
  }
}
class Ue extends U {
...
function Ir(e, t) {
  ...
  if (!t || t.length === 0)
    return e || [];
  const [n] = e, [r] = t;
  return (n.start < r.start ? mn(Ut(e, t)) : mn(Ut(t, e))).filter(
    (s) => s !== null
  );
}
function lc(e, t = !1) {
  return JSON.stringify(
    ...
    function(n, r) {
      var s;
      return !(this instanceof ne) && n === "symbol" ? r == null ? void 0 : r.id : (
...
function he(e) {
  const [t, n] = e.split(":");
  return Object.values(m).includes(t) ? new B({
    name: n,
    kind: t
  }) : new O();
}
function Ho(e) {
  const t = he(e).unwrap_or(void 0);
  if (!t)
    return !1;
...
function zo(e) {
  ...
  if (!t) return null;
  const { kind: n, name: r } = t;
  return n === "TablePartialInjection" ? it(
    r,
    "TablePartial"
    /* TablePartial */
  ) : null;
...
function sl(e) {
  return e instanceof Jt ? nl : null;
}
function gt(e) {
...
function il(e) {
  const [t] = e;
  return ct(t) || gt(t) && t.toLowerCase() >= "a" && t.toLowerCase() <= "f";
}
function Ce(e) {
  return gt(e) || ct(e);
}
...
function Lr(e) {
  var t;
  return e instanceof se ? `${(t = e.op) == null ? void 0 : t.value}${Lr(e.expression)}` : e.expression.literal.value;
}
function Ft(e) {
  var t;
  return e instanceof se ? ((t = e.op) == null ? void 0 : t.value) === "-" ? -Ft(e.expression) : Ft(e.expression) : Number.parseFloat(e.expression.literal.value);
}
...
class re {
  ...
  chain(t) {
    ...
    return new re(n.value, r);
  }
  map(t) {
    return new re(t(this.value), this.errors);
  }
}
function al(e, t, n) {
  if (!e || !Pe(e) || t.length === 0)
    return new O();
  const r = [...t], s = Un(e).unwrap(), i = r.pop();
  if (!(i instanceof Ee))
    return new O();
  const a = R(r) instanceof k ? r.pop() : void 0;
  if (r.length === 3) {
    const o = Un(r[1]).value;
    return !o || !Bt(o) ? new O() : new B(
      n.create(P, {
        type: s,
        name: r[0],
        as: o,
...
function Bt(e) {
  return (e == null ? void 0 : e.kind) === f.IDENTIFIER && e.value === "as";
}
function g(e) {
  e && (e instanceof te ? ol(e) : ll(e));
}
function ol(e) {
...
function ll(e) {
  if (e instanceof P)
    ...
    g(e.literal);
  else throw e instanceof Wt ? new Error("This case is handled by the TupleExpressionNode case") : new Error("Unreachable case in markInvalidNode");
}
function vr(e) {
...
function cl(e) {
  ...
  if (e instanceof ue)
    return j(e.name, e.colon, e.value);
  if (e instanceof ce)
  ...
  if (e instanceof de)
    return j(e.variable);
  if (e instanceof se)
    return j(e.op, e.expression);
  if (e instanceof Te)
    return j(e.leftExpression, e.op, e.rightExpression);
  if (e instanceof It)
    return j(e.expression, e.op);
  if (e instanceof ie)
    return j(e.value);
  if (e instanceof y)
    return j(e.callee, ...e.args);
  if (e instanceof Ee)
    return j(e.blockOpenBrace, ...e.body, e.blockCloseBrace);
  if (e instanceof k)
    return j(
      e.listOpenBracket,
      ...Rn(e.elementList, e.commaList),
      e.listCloseBracket
    );
  if (e instanceof be)
    return j(
  ...
  if (e instanceof ae)
    return j(e.callee, e.argumentList);
  if (e instanceof q)
  ...
  if (e instanceof Re) return j(e.partial);
  throw e instanceof Wt ? new Error("This case is already handled by TupleExpressionNode") : new Error("Unreachable - no other possible cases");
}
function Un(e) {
  return C(e) ? new B(e.expression.variable) : new O();
}
function H(e) {
  var t;
  return e instanceof q && (e.expression instanceof de && e.expression.variable instanceof te && e.expression.variable.kind === f.QUOTED_STRING || e.expression instanceof je && ((t = e.expression.literal) == null ? void 0 : t.kind) === f.STRING_LITERAL);
}
function C(e) {
  return e instanceof q && e.expression instanceof de && e.expression.variable instanceof te;
}
function Pe(e) {
  var t;
  return e instanceof q && e.expression instanceof de && ((t = e.expression.variable) == null ? void 0 : t.kind) === f.IDENTIFIER;
}
function At(e) {
  var t;
  return e instanceof Te && e.leftExpression instanceof U && e.rightExpression instanceof U && ((t = e.op) == null ? void 0 : t.value) === ".";
}
function Zt(e) {
  return C(e) ? !0 : At(e) && C(e.rightExpression) && Zt(e.leftExpression);
}
function $e(e) {
  if (e === void 0)
    return new O();
  const t = e.identifiers.map((n) => n.value).join(" ");
  return t === "" ? new O() : new B(t);
}
class ul {
...
` ? (this.current.line += 1, this.current.column = 0) : this.current.column += 1, this.current.offset += 1, t;
  ...
  lex() {
    return this.scanTokens(), this.tokens.push(te.create(f.EOF, this.start, this.current, "", !1)), this.gatherTrivia(), this.gatherInvalid(), new re(this.tokens, this.errors);
  }
  scanTokens() {
    for (; !this.isAtEnd(); ) {
...
`:
  ...
  gatherInvalid() {
    let t;
    const n = [], r = [];
    for (t = 0; t < this.tokens.length && vr(this.tokens[t]); t += 1)
...
`) && !r) {
    ...
    a && this.match(n), this.tokens.push(te.create(t, this.start, this.current, o, !1));
  }
...
`, {
  ...
  numericLiteralOrIdentifier() {
    ...
    if (t > 0) {
      for (; !this.isAtEnd() && (this.check(".") || Ce(this.peek())); )
        this.advance();
...
`;
      ...
      case "u": {
        let n = "";
        for (let r = 0; r <= 3; r += 1) {
          if (this.isAtEnd() || !Ce(this.peek()))
            return this.errors.push(new c(
              l.INVALID_ESCAPE_SEQUENCE,
              `Invalid unicode escape sequence '\\u${n}', only unicode escape sequences of the form '\\uHHHH' where H is a hexadecimal number are allowed`,
              te.create(f.STRING_LITERAL, t, this.current, `\\u${n}`, !0)
            )), `\\u${n}`;
          n += this.advance();
        }
...
var at = /* @__PURE__ */ ((e) => (e[e.ListExpression = 0] = "ListExpression", e[e.GroupExpression = 1] = "GroupExpression", e[e.BlockExpression = 2] = "BlockExpression", e))(at || {});
class hl {
  constructor() {
        ...
        switch (t[r].kind) {
          case f.COMMA:
            if (this.isWithinGroupExpressionContext() || this.isWithinListExpressionContext())
              return [...this.stack].reverse().find((i) => [
                1,
                0
                /* ListExpression */
              ].includes(i));
...
class pl {
  constructor(t, n) {
    this.current = 0, this.errors = [], this.contextStack = new hl(), this.synchronizeProgram = () => {
      const r = this.peek();
      ...
      for (; !this.isAtEnd(); ) {
        const r = this.peek();
        if (Bt(r) || this.check(f.COLON, f.LBRACE, f.LBRACKET))
          break;
        g(r), this.advance();
      }
    ...
    }, this.blockExpression = this.contextStack.withContextDo(at.BlockExpression, () => {
      const r = { body: [] }, s = () => this.nodeFactory.create(Ee, r);
      try {
      ...
      for (; !this.isAtEnd() && !this.check(f.RBRACE); )
        try {
          if (this.match(f.TILDE)) {
            const i = this.previous(), a = this.variable(), o = this.nodeFactory.create(Re, { op: i, partial: a });
            r.body.push(o);
          } else
      ...
      if (!this.check(f.RBRACE))
        for (g(this.advance()); !this.isAtEnd(); ) {
          const r = this.peek();
          if (this.check(f.RBRACE) || kn(this.previous(), r))
            break;
          g(r), this.advance();
        }
    }, this.tupleExpression = this.contextStack.withContextDo(at.GroupExpression, () => {
      const r = { elementList: [], commaList: [] }, s = () => this.nodeFactory.create(Wt, {
        groupOpenParen: r.tupleOpenParen,
        groupCloseParen: r.tupleCloseParen,
        expression: r.elementList[0]
      }), i = () => this.nodeFactory.create(be, r);
      try {
      ...
      for (; !this.isAtEnd() && !this.check(f.RPAREN); )
        try {
          ...
          if (!(a instanceof T))
            throw a;
          if (a.partialNode instanceof U && r.elementList.push(a.partialNode), !this.canHandle(a))
            throw new T(a.token, i(), a.handlerContext);
          this.synchronizeTuple();
        }
      try {
    ...
    }, this.listExpression = this.contextStack.withContextDo(at.ListExpression, () => {
      const r = { elementList: [], commaList: [] }, s = () => this.nodeFactory.create(k, r);
      try {
      ...
      for (; !this.isAtEnd() && !this.check(f.RBRACKET); )
        try {
          ...
          if (!(i instanceof T))
            throw i;
          if (i.partialNode instanceof U && r.elementList.push(i.partialNode), !this.canHandle(i))
            throw new T(i.token, s(), i.handlerContext);
          this.synchronizeList();
        }
      try {
    ...
    }, this.tokens = t, this.nodeFactory = new fl(n);
  }
  isAtEnd() {
    return this.current >= this.tokens.length || this.tokens[this.current].kind === f.EOF;
  }
  advance() {
    return this.isAtEnd() ? R(this.tokens) : this.tokens[this.current++];
  }
  peek(t = 0) {
    return t + this.current >= this.tokens.length ? R(this.tokens) : this.tokens[this.current + t];
  }
  match(...t) {
  ...
  parse() {
    const t = this.program(), n = this.advance(), r = this.nodeFactory.create(ne, { body: t, eof: n });
    return this.gatherInvalid(), new re({ ast: r, tokens: this.tokens }, this.errors);
  }
  ...
  expression() {
    const t = { args: [] }, n = () => al(t.callee, t.args, this.nodeFactory).unwrap_or(
      this.nodeFactory.create(y, t)
    );
    try {
    ...
    for (; !this.shouldStopExpression(); ) {
      Mt(this.previous()) || this.logError(r, l.MISSING_SPACES, "Expect a following space");
      try {
  ...
  shouldStopExpression() {
    if (this.isAtEnd() || Tr(this.previous()))
      return !0;
  ...
  expression_bp(t) {
    ...
    for (; !this.isAtEnd(); ) {
      ...
      if (r.kind === f.LPAREN) {
        ...
        kn(this.previous(), r) && !this.contextStack.isWithinGroupExpressionContext() && !this.contextStack.isWithinListExpressionContext())
          break;
        try {
          n = this.nodeFactory.create(ae, {
            callee: n,
            argumentList: this.tupleExpression()
          });
        } catch (i) {
          throw i instanceof T ? (n = this.nodeFactory.create(ae, {
            callee: n,
        ...
        if (Mt(this.previous()))
          break;
        try {
          n = this.nodeFactory.create(Ue, {
            expression: n,
            indexer: this.listExpression()
          });
        } catch (s) {
          throw s instanceof T ? (n = this.nodeFactory.create(Ue, {
            expression: n,
        ...
        if (i.left !== null) {
          if (i.left <= t)
            break;
          this.advance(), n = this.nodeFactory.create(It, {
            expression: n,
            op: s
          });
        } else {
          ...
          this.advance();
          try {
            n = this.nodeFactory.create(Te, {
              leftExpression: n,
              op: s,
              rightExpression: s.value === "." ? this.extractOperand() : this.expression_bp(a.right)
            });
          } catch (o) {
            throw o instanceof T ? (n = this.nodeFactory.create(Te, {
              leftExpression: n,
              op: s,
    ...
    if (Dn(this.peek())) {
      ...
      if (r.right === null)
        throw this.logError(
          ...
          n.op,
          this.nodeFactory.create(st, { pre: n.op }),
          this.contextStack.findHandlerContext(this.tokens, this.current)
        );
      this.advance();
      try {
        ...
        throw s instanceof T ? (n.expression = s.partialNode, new T(
          s.token,
          this.nodeFactory.create(se, n),
          s.handlerContext
        )) : s;
      }
      t = this.nodeFactory.create(se, n);
    } else if (t = this.extractOperand(), t instanceof st)
      throw new T(
        this.peek(),
        this.nodeFactory.create(st, { pre: this.peek() }),
        this.contextStack.findHandlerContext(this.tokens, this.current)
      );
    return t;
  }
  ...
  extractOperand() {
    ...
    ), this.nodeFactory.create(st, { pre: this.previous() }));
  }
  ...
  functionExpression() {
    ...
    try {
      ...
      throw n instanceof T ? (t.value = n.partialNode, new T(
        n.token,
        this.nodeFactory.create(ie, t),
        n.handlerContext
      )) : n;
    }
    return this.nodeFactory.create(ie, t);
  }
  variable() {
    this.consume("Expect a variable", f.IDENTIFIER);
    const t = this.previous();
    return this.nodeFactory.create(de, { variable: t });
  }
  canBeField() {
  ...
  attribute() {
    ...
    if (this.check(f.COLON, f.RBRACKET, f.COMMA)) {
      ...
      ), t.name = this.nodeFactory.create(ce, { identifiers: [] });
    } else
      try {
        ...
        if (t.name = n.partialNode, !this.canHandle(n))
          throw new T(
            n.token,
            this.nodeFactory.create(ue, t),
            n.handlerContext
          );
        this.synchronizeAttributeName();
      }
    return this.match(f.COLON) && (t.colon = this.previous(), t.value = this.attributeValue()), this.nodeFactory.create(ue, t);
  }
  attributeValue() {
    let t;
    try {
    ...
    for (; !this.isAtEnd() && !this.check(f.COLON, f.COMMA, f.RBRACKET); )
      try {
        ...
        throw n instanceof T ? new T(
          n.token,
          this.nodeFactory.create(ce, { identifiers: t }),
          n.handlerContext
        ) : n;
      }
    return this.nodeFactory.create(ce, { identifiers: t });
  }
  logError(t, n, r) {
...
function Mn(e) {
  return bl[e.value] || { left: null, right: null };
}
var _ = /* @__PURE__ */ ((e) => (e.Table = "table", e.Enum = "enum", e.Ref = "ref", e.Note = "note", e.Project = "project", e.Indexes = "indexes", e.TableGroup = "tablegroup", e.TablePartial = "tablepartial", e.Check = "checks", e))(_ || {}), E = /* @__PURE__ */ ((e) => (e.Color = "color", e.HeaderColor = "headercolor", e.Note = "note", e.PK = "pk", e.PrimaryKey = "primary key", e.Unique = "unique", e.Ref = "ref", e.NotNull = "not null", e.Null = "null", e.Increment = "increment", e.Default = "default", e.Name = "name", e.Type = "type", e.Check = "check", e.Update = "update", e.Delete = "delete", e))(E || {});
function Oe(e) {
  var n;
...
function ve(e) {
  ...
  if (!At(e))
    return new B([e]);
  const t = ve(e.leftExpression).unwrap_or(void 0);
  return t ? (t.push(e.rightExpression), new B(t)) : new O();
}
function Q(e) {
  if (e === void 0)
    return new O();
  const t = ve(e).unwrap_or(void 0);
  if (!t)
    return new O();
  const n = [];
  for (const r of t) {
    const s = Y(r).unwrap_or(void 0);
    if (!s)
      return new O();
    n.push(s);
  }
...
function et(e) {
  ...
  if (!C(R(t))) {
    const s = t.pop();
    if (Or(s))
      r = s.elementList.map((i) => W(i).unwrap());
    else
      return new O();
  }
  for (const s of t) {
    const i = Y(s).unwrap_or(void 0);
    if (!i)
      return new O();
    n.push(i);
  }
...
function Y(e) {
  return C(e) ? new B(e.expression.variable.value) : new O();
}
function ut(e) {
  if (Fn(e))
    return e instanceof ie ? new B({ functional: [e], nonFunctional: [] }) : new B({ functional: [], nonFunctional: [e] });
  if (e instanceof be && e.elementList.every(Fn)) {
    const t = e.elementList.filter(
      (r) => r instanceof ie
    ), n = e.elementList.filter(C);
    return new B({ functional: t, nonFunctional: n });
  }
  return new O();
}
function W(e) {
...
function V(e) {
  return H(e) ? e.expression instanceof de ? new B(e.expression.variable.value) : new B(e.expression.literal.value) : new O();
}
function Il(e) {
  var t;
  return !(e instanceof Te) || !wr((t = e.op) == null ? void 0 : t.value) ? !1 : et(e.leftExpression).and_then(() => et(e.rightExpression)).unwrap_or(void 0) !== void 0;
}
function _l(e) {
  const t = et(e.leftExpression), n = et(e.rightExpression);
  if (!t.isOk() || !n.isOk())
    return !1;
...
function Fn(e) {
  return e instanceof q && e.expression instanceof de || e instanceof ie;
}
function Bn(e, t) {
  var s, i, a, o;
  let n = t;
  ...
  for (; n; ) {
    ...
    if (((o = n.symbol) == null ? void 0 : o.declaration) instanceof ne && r)
      return n.symbol;
    if (n instanceof ne)
      return;
    n = n.parent;
...
class gl {
  ...
  validateContext() {
    return this.declarationNode.parent instanceof ne || Oe(this.declarationNode.parent).unwrap_or(void 0) !== _.Project ? [new c(l.INVALID_CUSTOM_CONTEXT, "A Custom element can only appear in a Project", this.declarationNode)] : [];
  }
  validateName(t) {
  ...
  validateBody(t) {
    ...
    const n = [];
    return H(t.callee) || n.push(new c(l.INVALID_CUSTOM_ELEMENT_VALUE, "A Custom element value can only be a string", t)), t.args.length > 0 && n.push(...t.args.map((r) => new c(l.INVALID_CUSTOM_ELEMENT_VALUE, "A Custom element value can only be a string", r))), n;
  }
}
class We {
  constructor() {
...
class Al {
  ...
  validateName(t) {
    return t ? yr(t) ? [] : [new c(l.INVALID_NAME, "An Enum name must be of the form <enum> or <schema>.<enum>", t)] : [new c(l.NAME_NOT_FOUND, "An Enum must have a name", this.declarationNode)];
  }
  validateAlias(t) {
    return t ? [new c(l.UNEXPECTED_ALIAS, "An Enum shouldn't have an alias", t)] : [];
  }
  registerElement() {
    const t = [];
    this.declarationNode.symbol = this.symbolFactory.create(qo, { declaration: this.declarationNode, symbolTable: new We() });
    const { name: n } = this.declarationNode, r = Q(n);
    if (r.isOk()) {
      const s = r.unwrap(), i = s.pop(), a = Lt(s, this.publicSymbolTable, this.symbolFactory), o = Kt(i);
  ...
  validateBody(t) {
    ...
    const [n, r] = oe(t.body, (s) => s instanceof y);
  ...
  validateFields(t) {
    return t.length === 0 ? [new c(l.EMPTY_ENUM, "An Enum must have at least one element", this.declarationNode)] : t.flatMap((n) => {
      const r = [];
      n.callee && !C(n.callee) && r.push(new c(l.INVALID_ENUM_ELEMENT_NAME, "An enum field must be an identifier or a quoted identifier", n.callee));
      const s = [...n.args];
      return R(s) instanceof k ? (r.push(...this.validateFieldSettings(R(s))), s.pop()) : s[0] instanceof k && (r.push(...this.validateFieldSettings(s[0])), s.shift()), s.length > 0 && r.push(...s.map((i) => new c(l.INVALID_ENUM_ELEMENT, "An Enum must have only a field and optionally a setting list", i))), r.push(...this.registerField(n)), r;
    });
  }
  validateFieldSettings(t) {
    const n = F(t), r = n.getErrors(), s = n.getValue();
    for (const i in s) {
      const a = s[i];
      switch (i) {
        case "note":
          a.length > 1 && a.forEach((o) => r.push(new c(l.DUPLICATE_ENUM_ELEMENT_SETTING, "'note' can only appear once", o))), a.forEach((o) => {
            H(o.value) || r.push(new c(l.INVALID_ENUM_ELEMENT_SETTING, "'note' must be a string", o));
          });
          break;
        default:
  ...
  registerField(t) {
    if (t.callee && C(t.callee)) {
      const n = W(t.callee).unwrap(), r = zt(n), s = this.symbolFactory.create(Qo, { declaration: t });
      t.symbol = s;
...
class Ll {
  ...
  validateContext() {
    ...
    if (this.declarationNode.parent instanceof ne) return [t];
    const n = Oe(this.declarationNode.parent).unwrap_or(void 0);
  ...
  validateFields(t) {
    return t.flatMap((n) => {
      ...
      return R(s) instanceof k && r.push(...this.validateFieldSetting(s.pop())), s.forEach((i) => {
        for (; i instanceof ae; )
          i.argumentList && !ut(i.argumentList).isOk() && r.push(new c(l.INVALID_INDEXES_FIELD, "An index field must be an identifier, a quoted identifier, a functional expression or a tuple of such", i.argumentList)), i = i.callee;
        ut(i).isOk() || r.push(new c(l.INVALID_INDEXES_FIELD, "An index field must be an identifier, a quoted identifier, a functional expression or a tuple of such", i));
      }), r;
    });
  }
      ...
      switch (i) {
        ...
        case "name":
          a.length > 1 && a.forEach((o) => r.push(new c(l.DUPLICATE_INDEX_SETTING, `'${i}' can only appear once`, o))), a.forEach((o) => {
            H(o.value) || r.push(new c(l.INVALID_INDEX_SETTING_VALUE, `'${i}' must be a string`, o));
          });
          break;
        case "unique":
        case "pk":
          a.length > 1 && a.forEach((o) => r.push(new c(l.DUPLICATE_INDEX_SETTING, `'${i}' can only appear once`, o))), a.forEach((o) => {
            ee(o.value) || r.push(new c(l.INVALID_INDEX_SETTING_VALUE, `'${i}' must not have a value`, o));
          });
          break;
        case "type":
          a.length > 1 && a.forEach((o) => r.push(new c(l.DUPLICATE_INDEX_SETTING, "'type' can only appear once", o))), a.forEach((o) => {
            C(o.value) || r.push(new c(l.INVALID_INDEX_SETTING_VALUE, `'type' must be "btree" or "hash"`, o));
          });
          break;
        default:
...
class vl {
  ...
  validateContext() {
    return !(this.declarationNode.parent instanceof ne) && ![
      _.Table,
      _.TableGroup,
      _.TablePartial,
      _.Project
    ].includes(Oe(this.declarationNode.parent).unwrap_or(void 0)) ? [new c(
  ...
  validateName(t) {
    if (!(this.declarationNode.parent instanceof ne))
  ...
  validateFields(t) {
    const n = [];
    return t.length === 0 ? [new c(l.EMPTY_NOTE, "A Note must have a content", this.declarationNode)] : (t.length > 1 && t.slice(1).forEach((r) => n.push(new c(l.NOTE_CONTENT_REDEFINED, "A Note can only contain one string", r))), H(t[0].callee) || n.push(new c(l.INVALID_NOTE, "A Note content must be a quoted string", t[0])), t[0].args.length > 0 && n.push(...t[0].args.map((r) => new c(l.INVALID_NOTE, "A Note can only contain one quoted string", r))), n);
  }
  validateSubElements(t) {
    return t.flatMap((n) => {
      if (n.parent = this.declarationNode, !n.type)
...
class yl {
  ...
  validateName(t) {
    return t ? He(t) ? [] : [new c(l.INVALID_NAME, "A Project's name is optional or must be an identifier or a quoted identifer", t)] : [];
  }
  validateAlias(t) {
...
class wl {
  ...
  validateContext() {
    return this.declarationNode.parent instanceof ne ? [] : [new c(l.INVALID_REF_CONTEXT, "A Ref must appear top-level", this.declarationNode)];
  }
  validateName(t) {
    return t ? He(t) ? [] : [new c(l.INVALID_NAME, "A Ref's name is optional or must be an identifier or a quoted identifer", t)] : [];
  }
  validateAlias(t) {
    return t ? [new c(l.UNEXPECTED_ALIAS, "A Ref shouldn't have an alias", t)] : [];
  }
  ...
  validateFields(t) {
    ...
    return t.length > 1 && n.push(...t.slice(1).map((r) => new c(l.REF_REDEFINED, "A Ref can only contain one binary relationship", r))), t.forEach((r) => {
      r.callee && !Il(r.callee) && n.push(new c(l.INVALID_REF_FIELD, "A Ref field must be a binary relationship", r.callee)), r.callee && !_l(r.callee) && n.push(new c(l.UNEQUAL_FIELDS_BINARY_REF, "Unequal fields in ref endpoints", r.callee));
      const s = [...r.args];
      if (R(s) instanceof k) {
        const i = this.validateFieldSettings(R(s));
        n.push(...i), s.pop();
      } else s[0] instanceof k && (n.push(...this.validateFieldSettings(s[0])), s.shift());
      ...
      switch (i) {
        ...
        case "update":
          a.length > 1 && a.forEach((o) => r.push(new c(l.DUPLICATE_REF_SETTING, `'${i}' can only appear once`, o))), a.forEach((o) => {
            Sl(o.value) || r.push(new c(l.INVALID_REF_SETTING_VALUE, `'${i}' can only have values "cascade", "no action", "set null", "set default" or "restrict"`, o));
          });
          break;
        case "color":
          a.length > 1 && r.push(...a.map((o) => new c(l.DUPLICATE_REF_SETTING, "'color' can only appear once", o))), a.forEach((o) => {
            vt(o.value) || r.push(new c(l.INVALID_REF_SETTING_VALUE, "'color' must be a color literal", o));
          });
          break;
        default:
...
function Sl(e) {
  if (!(C(e) && e.expression.variable.kind !== f.QUOTED_STRING) && !(e instanceof ce))
    return !1;
  let t;
  if (e instanceof ce ? t = $e(e).unwrap_or("") : t = e.expression.variable.value, t)
...
class Pl {
  ...
  validateName(t) {
    return t ? t instanceof Ue ? [new c(l.INVALID_NAME, "Invalid array as Table name, maybe you forget to add a space between the name and the setting list?", t)] : yr(t) ? [] : [new c(l.INVALID_NAME, "A Table name must be of the form <table> or <schema>.<table>", t)] : [new c(l.NAME_NOT_FOUND, "A Table must have a name", this.declarationNode)];
  }
  validateAlias(t) {
    return t ? Ul(t) ? [] : [new c(l.INVALID_ALIAS, "Table aliases can only contains alphanumeric and underscore unless surrounded by double quotes", t)] : [];
  }
  validateSettingList(t) {
    const n = F(t), r = n.getErrors(), s = n.getValue();
    return Ze(s, (i, a) => {
      switch (a) {
        case E.HeaderColor:
          i.length > 1 && r.push(...i.map((o) => new c(l.DUPLICATE_TABLE_SETTING, "'headercolor' can only appear once", o))), i.forEach((o) => {
            vt(o.value) || r.push(new c(l.INVALID_TABLE_SETTING_VALUE, "'headercolor' must be a color literal", o.value || o.name));
          });
          break;
        case E.Note:
          i.length > 1 && r.push(...i.map((o) => new c(l.DUPLICATE_TABLE_SETTING, "'note' can only appear once", o))), i.forEach((o) => {
            H(o.value) || r.push(new c(l.INVALID_TABLE_SETTING_VALUE, "'note' must be a string literal", o.value || o.name));
          });
          break;
        default:
          r.push(...i.map((o) => new c(l.UNKNOWN_TABLE_SETTING, `Unknown '${a}' setting`, o)));
      }
    }), r;
  }
  registerElement() {
    const t = [];
    this.declarationNode.symbol = this.symbolFactory.create(Ar, { declaration: this.declarationNode, symbolTable: new We() });
    const { name: n, alias: r } = this.declarationNode, s = Q(n);
    if (s.isOk()) {
      const i = [...s.unwrap()], a = i.pop(), o = Lt(i, this.publicSymbolTable, this.symbolFactory), u = lt(a);
    ...
    if (r && He(r) && !Ol(r.expression.variable.value, s.unwrap_or([]))) {
      const i = W(r).unwrap(), a = lt(i);
  ...
  validateBody(t) {
    ...
    const [n, r, s] = t.body.reduce((i, a) => (a instanceof y ? i[0].push(a) : a instanceof Re ? i[1].push(a) : a instanceof P && i[2].push(a), i), [[], [], []]);
    return [
  ...
  registerInjection(t) {
    ...
    const n = (p = t.partial.variable) == null ? void 0 : p.value, r = _r(n), s = this.symbolFactory.create(tl, { declaration: t });
    t.symbol = s;
  ...
  validateFields(t) {
    return t.flatMap((n) => {
      if (!n.callee)
        return [];
      const r = [];
      n.args.length === 0 && r.push(new c(l.INVALID_COLUMN, "A column must have a type", n.callee)), C(n.callee) || r.push(new c(l.INVALID_COLUMN_NAME, "A column name must be an identifier or a quoted identifier", n.callee)), n.args[0] && !xr(n.args[0]) && r.push(new c(l.INVALID_COLUMN_TYPE, "Invalid column type", n.args[0]));
  ...
  registerField(t) {
    if (t.callee && C(t.callee)) {
      const n = W(t.callee).unwrap(), r = _t(n), s = this.symbolFactory.create(Jt, { declaration: t });
      t.symbol = s;
      const i = this.declarationNode.symbol.symbolTable;
      if (i.has(r)) {
        const a = i.get(r);
  ...
  validateFieldSetting(t) {
    if (!t.slice(0, -1).every(Pe) || !t.slice(-1).every((u) => Pe(u) || u instanceof k))
      return [...t.map((u) => new c(l.INVALID_COLUMN, "These fields must be some inline settings optionally ended with a setting list", u))];
    if (t.length === 0)
      return [];
    let n;
    R(t) instanceof k && (n = t.pop());
    const r = F(n), s = r.getErrors(), i = r.getValue();
    t.forEach((u) => {
      const p = W(u).unwrap_or("").toLowerCase();
      if (p !== "pk" && p !== "unique") {
    ...
    const a = i[E.PK] || [], o = i[E.PrimaryKey] || [];
      ...
      switch (p) {
        case E.Note:
          u.length > 1 && s.push(...u.map((h) => new c(l.DUPLICATE_COLUMN_SETTING, "note can only appear once", h))), u.forEach((h) => {
            H(h.value) || s.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'note' must be a quoted string", h.value || h.name));
          });
          break;
        case E.Ref:
          u.forEach((h) => {
            Pr(h.value) || s.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'ref' must be a valid unary relationship", h.value || h.name));
          });
          break;
        case E.PrimaryKey:
          u.length > 1 && s.push(...u.map((h) => new c(l.DUPLICATE_COLUMN_SETTING, "primary key can only appear once", h))), u.forEach((h) => {
            ee(h.value) || s.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'primary key' must not have a value", h.value || h.name));
          });
          break;
        case E.PK:
          u.length > 1 && s.push(...u.map((h) => new c(l.DUPLICATE_COLUMN_SETTING, "'pk' can only appear once", h))), u.forEach((h) => {
            h instanceof ue && !ee(h.value) && s.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'pk' must not have a value", h.value || h.name));
          });
          break;
        case E.NotNull: {
          ...
          u.length >= 1 && h.length >= 1 && s.push(
            ...
            ee(d.value) || s.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'not null' must not have a value", d.value || d.name));
          });
          break;
        }
        case E.Null:
          u.length > 1 && s.push(...u.map((h) => new c(l.DUPLICATE_COLUMN_SETTING, "'null' can only appear once", h))), u.forEach((h) => {
            ee(h.value) || s.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'null' must not have a value", h.value || h.name));
          });
          break;
        case E.Unique:
          u.length > 1 && s.push(...u.map((h) => new c(l.DUPLICATE_COLUMN_SETTING, "'unique' can only appear once", h))), u.forEach((h) => {
            h instanceof ue && !ee(h.value) && s.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'unique' must not have a value", h.value || h.name));
          });
          break;
        case E.Increment:
          u.length > 1 && s.push(...u.map((h) => new c(l.DUPLICATE_COLUMN_SETTING, "'increment' can only appear once", h))), u.forEach((h) => {
            h instanceof ue && !ee(h.value) && s.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'increment' must not have a value", h.value || h.name));
          });
          break;
        case E.Default:
          u.length > 1 && s.push(...u.map((h) => new c(l.DUPLICATE_COLUMN_SETTING, "'default' can only appear once", h))), u.forEach((h) => {
            Sr(h.value) || s.push(new c(
        ...
        case E.Check:
          u.forEach((h) => {
            h.value instanceof ie || s.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'check' must be a function expression", h.value || h.name));
          });
          break;
        default:
...
class xl {
  ...
  registerElement() {
    ...
    this.declarationNode.symbol = this.symbolFactory.create(Jo, { declaration: this.declarationNode, symbolTable: new We() });
    const n = Q(t);
    if (n.isOk()) {
      const r = n.unwrap(), s = r.pop(), i = Lt(r, this.publicSymbolTable, this.symbolFactory), a = Yt(s);
      if (i.has(a))
      ...
      switch (a) {
        case "color":
          i.length > 1 && r.push(...i.map((o) => new c(
            ...
            vt(o.value) || r.push(new c(
              l.INVALID_TABLE_SETTING_VALUE,
        ...
        case "note":
          i.length > 1 && r.push(...i.map((o) => new c(
            ...
            o
          ))), i.filter((o) => !H(o.value)).forEach((o) => {
            r.push(new c(
              l.INVALID_TABLE_SETTING_VALUE,
  ...
  validateFields(t) {
    return t.flatMap((n) => {
      const r = [];
      return n.callee && !Q(n.callee).isOk() && r.push(new c(l.INVALID_TABLEGROUP_FIELD, "A TableGroup field must be of the form <table> or <schema>.<table>", n.callee)), this.registerField(n), n.args.length > 0 && r.push(...n.args.map((s) => new c(l.INVALID_TABLEGROUP_FIELD, "A TableGroup field should only have a single Table name", s))), r;
    });
  }
  validateSubElements(t) {
    const n = t.flatMap((s) => {
  ...
  registerField(t) {
    if (t.callee && C(t.callee)) {
      const n = W(t.callee).unwrap(), r = qt(n), s = this.symbolFactory.create(Zo, { declaration: t });
      t.symbol = s;
      const i = this.declarationNode.symbol.symbolTable;
      if (i.has(r)) {
        const a = i.get(r);
...
class kl {
      ...
      switch (a) {
        case E.HeaderColor:
          i.length > 1 && r.push(...i.map((o) => new c(l.DUPLICATE_TABLE_PARTIAL_SETTING, `'${a}' can only appear once`, o))), i.forEach((o) => {
            vt(o.value) || r.push(new c(l.INVALID_TABLE_PARTIAL_SETTING_VALUE, `'${a}' must be a color literal`, o.value || o.name));
          });
          break;
        case E.Note:
          i.length > 1 && r.push(...i.map((o) => new c(l.DUPLICATE_TABLE_PARTIAL_SETTING, `'${a}' can only appear once`, o))), i.forEach((o) => {
            H(o.value) || r.push(new c(l.INVALID_TABLE_PARTIAL_SETTING_VALUE, `'${a}' must be a string literal`, o.value || o.name));
          });
          break;
        default:
          r.push(...i.map((o) => new c(l.UNKNOWN_TABLE_PARTIAL_SETTING, `Unknown '${a}' setting`, o)));
      }
    }), r;
  }
  registerElement() {
    const { name: t } = this.declarationNode;
    this.declarationNode.symbol = this.symbolFactory.create(el, { declaration: this.declarationNode, symbolTable: new We() });
    const n = Q(t);
    if (!n.isOk()) return [];
    const r = n.unwrap(), s = r.pop(), i = Lt(r, this.publicSymbolTable, this.symbolFactory), a = Qt(s);
  ...
  validateFieldSetting(t) {
    const n = R(t);
    if (!t.slice(0, -1).every(Pe) || !(Pe(n) || n instanceof k))
    ...
    let r;
    R(t) instanceof k && (r = t.pop());
    const s = F(r), i = s.getErrors(), a = s.getValue();
    t.forEach((p) => {
      const h = W(p).unwrap_or("").toLowerCase();
    ...
    const o = a[E.PK] || [], u = a[E.PrimaryKey] || [];
      ...
      switch (h) {
        case E.Note:
          p.length > 1 && i.push(...p.map((d) => new c(l.DUPLICATE_COLUMN_SETTING, `'${h}' can only appear once`, d))), p.forEach((d) => {
            H(d.value) || i.push(new c(l.INVALID_COLUMN_SETTING_VALUE, `'${h}' must be a quoted string`, d.value || d.name));
          });
          break;
        case E.Ref:
          p.forEach((d) => {
            Pr(d.value) || i.push(new c(l.INVALID_COLUMN_SETTING_VALUE, `'${h}' must be a valid unary relationship`, d.value || d.name));
          });
          break;
        case E.PrimaryKey:
          p.length > 1 && i.push(...p.map((d) => new c(l.DUPLICATE_COLUMN_SETTING, `'${h}' can only appear once`, d))), p.forEach((d) => {
            ee(d.value) || i.push(new c(l.INVALID_COLUMN_SETTING_VALUE, `'${h}' must not have a value`, d.value || d.name));
          });
          break;
        case E.PK:
          p.length > 1 && i.push(...p.map((d) => new c(l.DUPLICATE_COLUMN_SETTING, `'${h}' can only appear once`, d))), p.forEach((d) => {
            d instanceof ue && !ee(d.value) && i.push(new c(l.INVALID_COLUMN_SETTING_VALUE, `'${h}' must not have a value`, d.value || d.name));
          });
          break;
        case E.NotNull: {
          p.length > 1 && i.push(...p.map((N) => new c(l.DUPLICATE_COLUMN_SETTING, `'${h}' can only appear once`, N)));
          const d = a[E.Null] || [];
          p.length >= 1 && d.length >= 1 && i.push(...[...p, ...d].map((N) => new c(
            l.CONFLICTING_SETTING,
            "'not null' and 'null' can not be set at the same time",
            N
          ))), p.forEach((N) => {
            ee(N.value) || i.push(new c(l.INVALID_COLUMN_SETTING_VALUE, `'${h}' must not have a value`, N.value || N.name));
          });
          break;
        }
        case E.Null:
        ...
        case E.Check:
          p.forEach((d) => {
            d.value instanceof ie || i.push(new c(l.INVALID_COLUMN_SETTING_VALUE, "'check' must be a function expression", d.value || d.name));
          });
          break;
        default:
...
class Rl {
  ...
  validateName(t) {
    return t ? [new c(l.UNEXPECTED_NAME, "A Checks shouldn't have a name", t)] : [];
  }
  validateAlias(t) {
    return t ? [new c(l.UNEXPECTED_ALIAS, "A Checks shouldn't have an alias", t)] : [];
  }
  validateSettingList(t) {
    return t ? [new c(l.UNEXPECTED_SETTINGS, "A Checks shouldn't have a setting list", t)] : [];
  }
  validateBody(t) {
    if (!t)
      return [];
    if (t instanceof y)
      return [new c(l.UNEXPECTED_SIMPLE_BODY, "A Checks must have a complex body", t)];
    const [n, r] = oe(t.body, (s) => s instanceof y);
    return [...this.validateFields(n), ...this.validateSubElements(r)];
  }
  validateFields(t) {
    return t.flatMap((n) => {
      if (!n.callee)
        return [];
      const r = [], s = [n.callee, ...n.args];
      return R(s) instanceof k && r.push(...this.validateFieldSetting(s.pop())), (s.length > 1 || !(s[0] instanceof ie)) && r.push(new c(l.INVALID_CHECKS_FIELD, "A check field must be a function expression", n)), r;
    });
  }
  validateFieldSetting(t) {
    const n = F(t), r = n.getErrors(), s = n.getValue();
    for (const i in s) {
      ...
      switch (i) {
        case "name":
          a.length > 1 && a.forEach((o) => r.push(new c(l.DUPLICATE_CHECK_SETTING, `'${i}' can only appear once`, o))), a.forEach((o) => {
            H(o.value) || r.push(new c(l.INVALID_CHECK_SETTING_VALUE, `'${i}' must be a string`, o));
          });
          break;
        default:
          a.forEach((o) => r.push(new c(l.UNKNOWN_CHECK_SETTING, `Unknown check setting '${i}'`, o)));
      }
    }
    return r;
  }
...
function yr(e) {
  return !!Q(e).unwrap_or(!1);
}
function Ul(e) {
  return He(e);
}
function He(e) {
  return e instanceof q && e.expression instanceof de;
}
function Lt(e, t, n) {
  var s;
  ...
  for (const i of e) {
    ...
    if (r.has(o)) {
      ...
      a = new We();
      const u = n.create(gr, { symbolTable: a });
      r.set(o, u);
    }
    r = a;
  }
...
function vt(e) {
  var n;
  if (!(e instanceof q) || !(e.expression instanceof je) || ((n = e.expression.literal) == null ? void 0 : n.kind) !== f.COLOR_LITERAL)
    return !1;
...
function Sr(e) {
  var n;
  if (H(e) || Me(e) || Pe(e) && ["true", "false", "null"].includes(e.expression.variable.value.toLowerCase()) || e instanceof se && Dl.includes((n = e.op) == null ? void 0 : n.value) && Me(e.expression) || e instanceof ie)
    return !0;
  if (!e || !Zt(e)) return !1;
  const t = ve(e).unwrap();
...
function Me(e) {
  var t, n, r;
  return e instanceof se ? ((t = e.op) == null ? void 0 : t.value) !== "-" && ((n = e.op) == null ? void 0 : n.value) !== "+" ? !1 : Me(e.expression) : e instanceof q && e.expression instanceof je && ((r = e.expression.literal) == null ? void 0 : r.kind) === f.NUMERIC_LITERAL;
}
function Pr(e) {
  var n;
  if (!(e instanceof se) || !wr((n = e.op) == null ? void 0 : n.value))
    return !1;
  const t = Q(e.expression).unwrap_or(void 0);
  return t !== void 0 && t.length > 0;
}
function Or(e) {
  return e instanceof be && e.elementList.every(C);
}
function xr(e) {
  if (!(e instanceof ae || At(e) || e instanceof q || e instanceof Ue))
    return !1;
  if (e instanceof ae) {
    if (e.callee === void 0 || e.argumentList === void 0 || !e.argumentList.elementList.every((n) => Me(n) || H(n) || Pe(n)))
      return !1;
    e = e.callee;
  }
  for (; e instanceof Ue; ) {
    if (e.array === void 0 || e.indexer === void 0 || !e.indexer.elementList.every((n) => !n.colon && !n.value && Me(n.name)))
      return !1;
    e = e.array;
  }
  const t = Q(e).unwrap_or(void 0);
  return t !== void 0 && t.length > 0;
}
function F(e) {
  const t = {}, n = [];
  return e ? (e.elementList.forEach((r) => {
    var i;
    if (!r.name) return;
    if (r.name instanceof q) {
      n.push(new c(l.INVALID_SETTINGS, "A setting name must be a stream of identifiers", r.name));
      return;
    }
    const s = (i = $e(r.name).unwrap_or(void 0)) == null ? void 0 : i.toLowerCase();
    s && (t[s] === void 0 ? t[s] = [r] : t[s].push(r));
  }), new re(t, n)) : new re({});
}
class Vn {
  constructor(t, n) {
    this.ast = t, this.symbolFactory = n, this.publicSchemaSymbol = this.symbolFactory.create(gr, {
      symbolTable: new We()
  ...
  validate() {
    ...
    const n = this.ast.body.filter((r) => Oe(r).unwrap_or(void 0) === _.Project);
    return n.length > 1 && n.forEach((r) => t.push(new c(l.PROJECT_REDEFINED, "Only one project can exist", r))), new re(this.ast, t);
  }
}
class Ie {
  constructor(t, n) {
  ...
  bindSettingList(t, n) {
    t && t.elementList.forEach((r) => {
      if (r.name instanceof q) return;
      const s = $e(r.name).unwrap_or(void 0);
      if (!s) return;
  ...
  bindBody() {
    ...
    if (!t.body) return;
    const { body: n } = t;
    n instanceof Ee ? n.body.forEach((r) => {
      if (r instanceof P) {
        if (!r.type || Oe(this.declarationNode).unwrap_or(null) === _.TablePartial && Oe(r).unwrap_or(null) === _.Indexes) return;
        const s = Dr(r);
        new s(r, this.errors).bind();
      } else r instanceof y ? this.bindSubfield(r) : this.bindPartialInjection(r);
    }) : this.bindSubfield(n);
  }
  bindSubfield(t) {
    const n = [t.callee, ...t.args], r = R(n);
    r instanceof k && (n.pop(), this.bindSettingList(r, this.subfield.settingList));
  ...
  scanAndBind(t, n) {
    ...
    if (t)
      if (t instanceof q) {
        if (t.expression instanceof de && ((s = n.keywords) != null && s.includes((r = t.expression.variable) == null ? void 0 : r.value.toLowerCase())))
          return;
        this.bindFragments([t], n);
      } else t instanceof Te ? At(t) ? this.bindFragments(ve(t).unwrap_or([]), n) : (this.scanAndBind(t.leftExpression, n), this.scanAndBind(t.rightExpression, n)) : t instanceof se ? this.scanAndBind(t.expression, n) : t instanceof It ? this.scanAndBind(t.expression, n) : t instanceof be ? t.elementList.forEach((i) => this.scanAndBind(i, n)) : t instanceof Re && this.bindFragments([t], n);
  }
  ...
  bindFragments(t, n) {
    if (t.length === 0) return;
    const r = t.length === 1 && t[0] instanceof Re, s = [...n.topSubnamesSymbolKind], i = r ? -1 : t.findIndex((N) => !C(N)), o = i !== -1 && Or(t[i]) ? t[i] : void 0, u = i >= 0 ? s.pop() : void 0, p = t.slice(
      0,
      i === -1 ? void 0 : i
    );
    ...
    for (; s.length && p.length; ) {
      const N = s.pop(), b = p.pop(), A = W(b).unwrap();
      h.unshift({
        index: it(A, N),
        referrer: b
      });
    ...
    for (; p.length; ) {
      const N = p.pop(), b = r ? ml(N).unwrap() : W(N).unwrap();
      h.unshift({
        index: it(b, n.remainingSubnamesSymbolKind),
        referrer: N
      });
    }
    const d = H(t[0]);
    return o ? o.elementList.forEach((N) => this.resolveIndexStack(
      [
        ...h,
        {
          index: it(
  ...
  resolveIndexStack(t, n, r) {
    if (t.length === 0)
      throw new Error("Unreachable - An unresolved name must have at least one name component");
    const [s, ...i] = t, a = Bn(s.index, this.declarationNode);
    if (a === void 0) {
      const { kind: h, name: d } = he(s.index).unwrap();
      this.logError(
        s.referrer,
        `Can not find ${h} '${d}'`,
        n.ignoreNameNotFound || !!n.ignoreNameNotFoundForQuotedVariable && r
      );
      return;
    }
    a.references.push(s.referrer), s.referrer.referee = a;
    let o = a.symbolTable, { kind: u, name: p } = he(s.index).unwrap();
    for (const h of i) {
      const { kind: d, name: N } = he(h.index).unwrap(), b = o.get(h.index);
      if (!b) {
        this.logError(
          h.referrer,
          `${u} '${p}' does not have ${d} '${N}'`,
          n.ignoreNameNotFound
        );
        return;
      }
      if (u = d, p = N, h.referrer.referee = b, b.references.push(h.referrer), !b.symbolTable)
        break;
      o = b.symbolTable;
    }
  }
  ...
  resolveInjections(t) {
    ...
    n.forEach((i, a) => {
      var p, h;
      if (!Ko(a)) return;
      const o = Bn(zo(a), this.declarationNode), u = (h = (p = o == null ? void 0 : o.declaration) == null ? void 0 : p.symbol) == null ? void 0 : h.symbolTable;
      u && u.forEach((d, N) => {
        n.has(N) || r.set(N, { injectorFieldSymbol: d, injectorDeclaration: i.declaration });
      });
    }), r.forEach((i, a) => {
      const o = sl(i.injectorFieldSymbol);
      if (!o) return;
        ...
        argBinderRules: [
          {
            ...
            ignoreNameNotFoundForQuotedVariable: !1
          },
          {
            shouldBind: !0,
            topSubnamesSymbolKind: [m.Table, m.Column],
      ...
      arg: {
        argBinderRules: [
          { shouldBind: !1 },
          {
            ...
            ignoreNameNotFoundForQuotedVariable: !0
          }
        ]
      },
      settingList: {
        ...
        default: {
          shouldBind: !0,
          topSubnamesSymbolKind: [m.Enum, m.EnumField],
          remainingSubnamesSymbolKind: m.Schema,
          ignoreNameNotFound: !1,
...
class Hl {
  ...
  resolve(t) {
    return this.ast.body.map((n) => {
      ...
      const r = Dr(n), s = new r(n, this.errors);
      return s.resolveInjections(t), s;
    }).forEach((n) => n == null ? void 0 : n.bind()), new re(this.ast, this.errors);
  }
}
class Kl {
  constructor(t) {
...
class zl {
  constructor(t, n) {
    this.ast = t, this.symbolFactory = new Kl(n);
  }
  // Analyzing: Invoking both the validator and binder
  analyze() {
    return new Vn(this.ast, this.symbolFactory).validate().chain((n) => new Hl(n).resolve(this.symbolFactory));
  }
  // For invoking the validator only
  validate() {
    return new Vn(this.ast, this.symbolFactory).validate().chain((n) => new re(n, []));
  }
}
function Cn(e, t) {
  const { variables: n, tupleElements: r } = et(e).unwrap();
  return r ? n.length === 0 ? {
...
function ht(e) {
  var n;
  const t = (n = ve(e).unwrap_or(void 0)) == null ? void 0 : n.pop();
  return t instanceof be ? t.elementList.map((r) => r.referee) : [t.referee];
}
function Ve(e) {
  const t = Q(e).unwrap();
  return {
...
function Ur(e) {
  if (e) {
    ...
    if (Zt(e))
      return {
        value: ve(e).map(R).and_then(Y).unwrap(),
        type: "string"
      };
    throw new Error("Unreachable");
  }
...
function Mr(e) {
  let t = null;
  e instanceof ae && (t = e.argumentList.elementList.map((i) => Me(i) ? Lr(i) : H(i) ? V(i).unwrap() : Y(i).unwrap()).join(","), e = e.callee);
  let n = "";
  for (; e instanceof Ue; )
    n = `[${e.indexer.elementList.map((i) => i.name.expression.literal.value).join(",")}]${n}`, e = e.array;
  const { name: r, schemaName: s } = Ve(e);
  return s.length > 1 ? new re(
    {
...
class Fr {
  ...
  interpretName(t) {
    const { name: n, schemaName: r } = Ve(t);
  ...
  interpretSettingList(t) {
    var s, i, a;
    const n = F(t).getValue();
    this.table.headerColor = (s = n[E.HeaderColor]) != null && s.length ? nt((a = (i = n[E.HeaderColor]) == null ? void 0 : i.at(0)) == null ? void 0 : a.value) : void 0;
    const [r] = n[E.Note] || [];
    return this.table.note = r && {
      value: V(r == null ? void 0 : r.value).map(fe).unwrap(),
      token: L(r)
    }, [];
  }
  interpretBody(t) {
    const [n, r] = oe(t.body, (s) => s instanceof y || s instanceof Re);
    return [
      ...
      switch ((r = n.type) == null ? void 0 : r.value.toLowerCase()) {
        case _.Note:
          return this.table.note = {
            value: V(
              n.body instanceof Ee ? n.body.body[0].callee : n.body.callee
            ).map(fe).unwrap(),
            token: L(n)
          }, [];
        case _.Indexes:
  ...
  interpretFields(t) {
    ...
    const s = ((a = this.declarationNode.symbol) != null && a.symbolTable ? [...this.declarationNode.symbol.symbolTable.entries()] : []).filter(([o]) => {
      const u = he(o).unwrap_or(null);
      return (u == null ? void 0 : u.kind) === m.Column;
    }).length ? [] : [new c(l.EMPTY_TABLE, "A Table must have at least one column", this.declarationNode)], i = t.flatMap((o, u) => o instanceof y ? this.interpretColumn(o) : this.interpretInjection(o, u));
    return [
      ...s,
      ...i
    ];
  ...
  interpretColumn(t) {
    var a, o, u, p, h, d, N, b, A;
    const n = [], r = {};
    r.name = W(t.callee).unwrap();
    const s = Mr(t.args[0]);
    r.type = s.getValue(), n.push(...s.getErrors()), r.token = L(t), r.inline_refs = [];
    const i = t.args.slice(1);
    if (R(i) instanceof k) {
      const I = F(i.pop()).getValue();
      r.pk = !!((a = I[E.PK]) != null && a.length) || !!((o = I[E.PrimaryKey]) != null && o.length), r.increment = !!((u = I[E.Increment]) != null && u.length), r.unique = !!((p = I[E.Unique]) != null && p.length), r.not_null = (h = I[E.NotNull]) != null && h.length ? !0 : (d = I[E.Null]) != null && d.length ? !1 : void 0, r.dbdefault = Ur((b = (N = I[E.Default]) == null ? void 0 : N.at(0)) == null ? void 0 : b.value);
      const v = (A = I[E.Note]) == null ? void 0 : A.at(0);
      r.note = v && {
        value: V(v.value).map(fe).unwrap(),
        token: L(v)
      };
      const K = I[E.Ref] || [];
      r.inline_refs = K.flatMap((w) => {
        const [J] = ht(w.value.expression);
        if (en(J, t.symbol))
          return n.push(new c(l.SAME_ENDPOINT, "Two endpoints are the same", w)), [];
        const G = w.value.op, $ = Q(w.value.expression).unwrap();
        let le;
        if ($.length === 1) {
          const [Z] = $;
          le = {
          ...
          n.push(new c(l.UNSUPPORTED, "Nested schema is not supported", w));
          const Z = $.pop(), we = $.pop();
          le = {
            schemaName: $.join("."),
            tableName: we,
        ...
        const ye = this.registerInlineRefToEnv(t, J, le, w);
        return n.push(...ye), ye.length === 0 ? le : [];
      });
      const z = I[E.Check] || [];
      r.checks = z.map((w) => {
        const J = L(w), G = w.value.value.value;
        return {
          token: J,
          expression: G
        };
    ...
    return r.pk || (r.pk = i.some((I) => Y(I).unwrap().toLowerCase() === "pk")), r.unique || (r.unique = i.some((I) => Y(I).unwrap().toLowerCase() === "unique")), this.table.fields.push(r), r.pk && this.pkColumns.push(r), n;
  }
  interpretIndexes(t) {
    return this.table.indexes.push(...t.body.body.map((n) => {
      ...
      if (R(i) instanceof k) {
        const b = F(i.pop()).getValue();
        r.pk = !!((a = b[E.PK]) != null && a.length), r.unique = !!((o = b[E.Unique]) != null && o.length), r.name = V((p = (u = b[E.Name]) == null ? void 0 : u.at(0)) == null ? void 0 : p.value).unwrap_or(void 0);
        const A = (h = b[E.Note]) == null ? void 0 : h.at(0);
        r.note = A && {
          value: V(A.value).unwrap(),
          token: L(A)
        }, r.type = Y((N = (d = b[E.Type]) == null ? void 0 : d.at(0)) == null ? void 0 : N.value).unwrap_or(void 0);
      }
      return i.flatMap((b) => {
        if (!(b instanceof ae))
          return b;
        ...
        const { functional: A, nonFunctional: I } = ut(b).unwrap();
        r.columns.push(
          ...A.map((v) => ({
            value: v.value.value,
            type: "expression",
  ...
  interpretChecks(t) {
    return this.table.checks.push(...t.body.body.map((n) => {
      var i, a;
      const r = {}, s = n;
      if (r.token = L(s), s.args[0] instanceof k) {
        const o = F(s.args[0]).getValue();
        r.name = V((a = (i = o[E.Name]) == null ? void 0 : i.at(0)) == null ? void 0 : a.value).unwrap_or(void 0);
      }
      return r.expression = s.callee.value.value, r;
    })), [];
  }
  registerInlineRefToEnv(t, n, r, s) {
    const i = Rr(t.symbol, n);
...
class Yl {
  ...
  interpretSettingList(t) {
    var r, s, i;
    const n = F(t).getValue();
    return this.note.headerColor = (r = n.headercolor) != null && r.length ? nt((i = (s = n.headercolor) == null ? void 0 : s.at(0)) == null ? void 0 : i.value) : void 0, [];
  }
  interpretBody(t) {
    const [n, r] = oe(t.body, (s) => s instanceof y);
  ...
  interpretNote(t) {
    const n = lr(t, "callee.expression.literal.value", "");
    return this.note.content = fe(n), [];
  }
}
class Br {
  constructor(t, n) {
  ...
  interpretName(t) {
    const n = [], r = Q(this.declarationNode.name).unwrap_or([]);
  ...
  interpretBody(t) {
    return t instanceof y ? this.interpretField(t) : this.interpretField(t.body[0]);
  }
  interpretField(t) {
    var p, h, d, N, b, A, I;
    const n = t.callee.op.value, { leftExpression: r, rightExpression: s } = t.callee, i = ht(r), a = ht(s);
    if (en(i, a))
    ...
    if (t.args[0]) {
      const v = F(t.args[0]).getValue(), K = (h = (p = v.delete) == null ? void 0 : p.at(0)) == null ? void 0 : h.value;
      this.ref.onDelete = K instanceof ce ? $e(K).unwrap_or(void 0) : Y(K).unwrap_or(void 0);
      const z = (N = (d = v.update) == null ? void 0 : d.at(0)) == null ? void 0 : N.value;
      this.ref.onUpdate = z instanceof ce ? $e(z).unwrap_or(void 0) : Y(z).unwrap_or(void 0), this.ref.color = (b = v.color) != null && b.length ? nt((I = (A = v.color) == null ? void 0 : A.at(0)) == null ? void 0 : I.value) : void 0;
    }
    const u = kr(n);
...
class Vr {
  ...
  interpretName(t) {
    const n = [], { name: r, schemaName: s } = Ve(t);
  ...
  interpretSettingList(t) {
    var s, i, a;
    const n = F(t).getValue();
    this.tableGroup.color = (s = n.color) != null && s.length ? nt((a = (i = n.color) == null ? void 0 : i.at(0)) == null ? void 0 : a.value) : void 0;
    const [r] = n.note || [];
...
class Cr {
  ...
  interpretBody(t) {
    return t.body.flatMap((n) => {
      var o;
      const r = n, s = {};
      s.token = L(r), s.name = Y(r.callee).unwrap();
      const a = (o = F(r.args[0]).getValue().note) == null ? void 0 : o.at(0);
      return s.note = a && {
        value: V(a.value).map(fe).unwrap(),
        token: L(a)
...
class Gr {
  ...
  interpretSettingList(t) {
    const n = F(t).getValue(), r = Bo(n[E.HeaderColor]);
    this.tablePartial.headerColor = r ? nt(r.value) : void 0;
    const [s] = n[E.Note] || [];
    return this.tablePartial.note = s && {
      value: V(s == null ? void 0 : s.value).map(fe).unwrap(),
      token: L(s)
    }, [];
  }
  interpretBody(t) {
  ...
  interpretColumn(t) {
    ...
    if (R(i) instanceof k) {
      ...
      r.inline_refs = K.flatMap((w) => {
        ...
        if ($.length === 2) {
          ...
          n.push(new c(l.UNSUPPORTED, "Unsupported", w));
          const ye = $.pop(), Z = $.pop();
          le = {
            schemaName: $.join("."),
            tableName: Z,
    ...
    return r.pk || (r.pk = i.some((I) => Y(I).unwrap().toLowerCase() === "pk")), r.unique || (r.unique = i.some((I) => Y(I).unwrap().toLowerCase() === "unique")), this.tablePartial.fields.push(r), r.pk && this.pkColumns.push(r), n;
  }
  interpretIndexes(t) {
  ...
  interpretChecks(t) {
    return this.tablePartial.checks.push(...t.body.body.map((n) => {
      var i, a;
      const r = {}, s = n;
      if (r.token = L(s), s.args[0] instanceof k) {
        const o = F(s.args[0]).getValue();
...
class ql {
  constructor(t, n) {
    this.declarationNode = t, this.env = n, this.project = {
      enums: [],
      refs: [],
      tableGroups: [],
      tables: [],
  ...
  interpretBody(t) {
    return t.body.flatMap((n) => {
      ...
      switch ((s = r.type) == null ? void 0 : s.value.toLowerCase()) {
        ...
        case "tablegroup": {
          const i = new Vr(r, this.env).interpret();
          return this.project.tableGroups.push(this.env.tableGroups.get(r)), i;
        }
        case "enum": {
          const i = new Cr(r, this.env).interpret();
          return this.project.enums.push(this.env.enums.get(r)), i;
        }
        case "note":
          return this.project.note = {
            value: V(
              r.body instanceof Ee ? r.body.body[0].callee : r.body.callee
            ).map(fe).unwrap(),
            token: L(r)
          }, [];
        case "tablepartial": {
          const i = new Gr(r, this.env).interpret();
...
class $r {
  ...
  provideCompletionItems(t, n) {
    var h, d;
    const r = tn(t, n), s = this.compiler.token.flatStream(), { token: i, index: a } = this.compiler.container.token(r), o = a === void 0 ? s[0] : s[a + 1];
    if ([
    ...
    if (this.compiler.container.scopeKind(r) === D.TOPLEVEL || u instanceof P && u.type && u.type.start <= r && u.type.end >= r)
      return Wn();
    ...
    for (const N of p)
      if (N instanceof se)
        ...
        if (N instanceof ue)
          return $n(this.compiler, r, N);
        if (N instanceof k)
          return $n(this.compiler, r, N);
        if (N instanceof be)
          return ec(this.compiler, r);
        if (N instanceof Re)
          return Zl(this.compiler, r);
        if (N instanceof y)
          return jn(this.compiler, r, N);
        if (N instanceof P && (N.bodyColon && r >= N.bodyColon.end || N.body && qe(r, N.body)))
          return jn(this.compiler, r, void 0);
      }
    return X();
  }
}
function Zl(e, t) {
  ...
  return Ke(e, t, n, [m.TablePartial]);
}
function Gn(e, t, n) {
  ...
  if ([
    ...
    const s = Ke(e, t, e.container.element(t), [
      m.Table,
      m.Schema,
      m.Column
    ]);
    return ft(n.op, t) ? pt(s) : s;
  }
  return X();
}
function Ke(e, t, n, r) {
    ...
    if ((a = s == null ? void 0 : s.symbol) != null && a.symbolTable) {
      ...
      i.suggestions.push(
        ...e.symbol.members(o).filter(({ kind: u }) => r.includes(u)).map(({ name: u, kind: p }) => ({
          label: u,
          insertText: u,
          insertTextRules: M.KeepWhitespace,
          kind: tt(p),
          sortText: tt(p).toString().padStart(2, "0"),
          range: void 0
        }))
      );
    }
    ...
    case D.REF:
      {
        ...
        for (; s.length > 0; ) {
          const i = s.pop();
          if (i instanceof Te && ((r = i.op) == null ? void 0 : r.value) === ".")
            return Xr(
              e,
              t,
              i
...
function $n(e, t, n) {
  ...
  if ([f.COMMA, f.LBRACKET].includes(r == null ? void 0 : r.kind)) {
    const s = Xn(e, t);
    return (r == null ? void 0 : r.kind) === f.COMMA && ft(r, t) ? pt(s) : s;
  }
  if (n.name && n.name.start <= t && n.name.end >= t)
    return Xn(e, t);
  if (n.name instanceof ce) {
    const s = tc(
      e,
      t,
      $e(n.name).unwrap_or("")
    );
    return (r == null ? void 0 : r.kind) === f.COLON && ft(r, t) ? pt(s) : s;
  }
  return X();
}
function Xn(e, t) {
  const n = e.container.element(t);
  if (n instanceof ne) return X();
  const r = e.container.scopeKind(t);
    ...
    case D.TABLEPARTIAL:
      return {
        suggestions: [
          ...
          ...[E.Ref, E.Default, E.Note, E.Check].map((s) => ({
            label: s,
            insertText: `${s}: `,
            kind: S.Property,
            insertTextRules: M.KeepWhitespace,
...
function tc(e, t, n) {
  switch (n == null ? void 0 : n.toLowerCase()) {
    ...
    case "default":
      return Ke(e, t, e.container.element(t), [
        m.Schema,
        m.Enum
      ]);
  }
...
function Xr(e, t, n) {
  const r = ve(n).unwrap_or([]);
  if (r.pop(), r.some((i) => !C(i)))
    return X();
  const s = r.map((i) => Y(i).unwrap());
  return yt({
...
function jn(e, t, n) {
  ...
  switch (e.container.scopeKind(t)) {
    ...
    case D.REF: {
      const i = jr(e, t);
      return ((s = e.container.token(t).token) == null ? void 0 : s.kind) === f.COLON && ft(e.container.token(t).token, t) ? pt(i) : i;
    }
    case D.TABLEGROUP:
      return ic(e);
    default:
...
function nc(e, t, n) {
  return n != null && n.callee && nn(t, n) === 1 ? Ke(e, t, e.container.element(t), [
    m.Schema,
    m.Table,
    m.Column
  ]) : X();
...
function sc(e, t, n) {
  ...
  return n != null && n.callee ? nn(t, n) === 0 ? {
    suggestions: r.map((i) => ({
      label: i,
      insertText: i,
      insertTextRules: M.KeepWhitespace,
...
function Wr(e, t) {
  ...
  if (!((r == null ? void 0 : r.symbol) instanceof Ar))
    return X();
  const { symbolTable: s } = r.symbol;
  return yt({
    suggestions: [...s.entries()].flatMap(([i]) => {
      const a = he(i).unwrap_or(void 0);
      if (a === void 0)
        return [];
      const { name: o } = a;
      return {
...
class Hr {
  ...
  provideDefinition(t, n) {
    var a, o;
    const { uri: r } = t, s = tn(t, n), i = [...this.compiler.container.stack(s)];
    for (; i.length !== 0; ) {
      const u = i.pop();
      if (!(u != null && u.referee)) continue;
      let p;
      if ((a = u.referee) != null && a.declaration && [
        xe.PRIMARY_EXPRESSION,
        xe.VARIABLE,
        xe.PARTIAL_INJECTION
...
class Kr {
  ...
  provideReferences(t, n) {
    ...
    for (; i.length !== 0; ) {
      const a = i.pop();
      if (a && [
        xe.ELEMENT_DECLARATION,
        xe.FUNCTION_APPLICATION,
        xe.PRIMARY_EXPRESSION
...
const cc = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  CompletionItemInsertTextRule: M,
  CompletionItemKind: S,
  DBMLCompletionItemProvider: $r,
  DBMLDefinitionProvider: Hr,
  DBMLReferencesProvider: Kr
}, Symbol.toStringTag, { value: "Module" }));
var D = /* @__PURE__ */ ((e) => (e[e.TABLE = 0] = "TABLE", e[e.ENUM = 1] = "ENUM", e[e.TABLEGROUP = 2] = "TABLEGROUP", e[e.INDEXES = 3] = "INDEXES", e[e.NOTE = 4] = "NOTE", e[e.REF = 5] = "REF", e[e.PROJECT = 6] = "PROJECT", e[e.CUSTOM = 7] = "CUSTOM", e[e.TOPLEVEL = 8] = "TOPLEVEL", e[e.TABLEPARTIAL = 9] = "TABLEPARTIAL", e[e.CHECKS = 10] = "CHECKS", e))(D || {});
class uc {
  constructor() {
    this.source = "", this.cache = new Array(
      16
      /* TOTAL_QUERY_COUNT */
    ).fill(null), this.nodeIdGenerator = new jo(), this.symbolIdGenerator = new Yo(), this.token = {
      invalidStream: this.createQuery(6, () => this.parse.tokens().filter(vr)),
      // Valid + Invalid tokens (which are guarenteed to be non-trivials) are included in the stream
      flatStream: this.createQuery(7, () => this.parse.tokens().flatMap((t) => [...t.leadingInvalid, t, ...t.trailingInvalid]))
    }, this.parse = {
      source: () => this.source,
      _: this.createQuery(
        0,
        () => {
          const t = new ul(this.source).lex().chain((n) => new pl(n, this.nodeIdGenerator).parse()).chain(({ ast: n, tokens: r }) => new zl(n, this.symbolIdGenerator).analyze().map(() => ({ ast: n, tokens: r })));
          return t.getErrors().length > 0 ? t : t.chain(({ ast: n, tokens: r }) => new Jl(n).interpret().map((i) => ({ ast: n, tokens: r, rawDb: i })));
        }
      ),
      ...
      stack: this.createQuery(
        10,
        (t) => {
          const n = this.token.flatStream(), { index: r, token: s } = this.container.token(t), i = r === void 0 ? -1 : Fo(n, (p) => !p.isInvalid, r);
          if (i === -1)
          ...
          const u = [o];
          for (; ; ) {
            const h = cl(o).find((d) => qe(a, d));
            if (h === void 0 || h instanceof te)
              break;
            u.push(h), o = h;
          }
          ...
          for (; u.length > 0; ) {
            ...
            if (h instanceof y) {
              ...
              for (let N = h.end; N < t; N += 1)
                d[N] === `
` && (u.pop(), p = !0);
            } else h instanceof se || h instanceof Te ? this.container.token(t).token !== h.op && (u.pop(), p = !0) : h instanceof k ? h.listCloseBracket && h.end <= t && (u.pop(), p = !0) : h instanceof be ? h.tupleCloseParen && h.end <= t && (u.pop(), p = !0) : h instanceof Ee ? h.blockCloseBrace && h.end <= t && (u.pop(), p = !0) : h instanceof ce || h.end < t && (u.pop(), p = !0);
            if (p) {
              const d = R(u);
      ...
      scopeKind: this.createQuery(15, (t) => {
        var r;
        if (this.container.element(t) instanceof ne)
          return 8;
      ...
      ofName: this.createQuery(
        ...
        ({
          ...
          for (let i = n; i; i = i instanceof P ? i.parent : void 0) {
            ...
            let o = [a], u = [];
            for (const p of t)
              u = o.flatMap((h) => rl(p).flatMap((d) => {
                const N = h.get(d), b = he(d).unwrap_or(void 0);
                return !N || !b ? [] : { ...b, symbol: N };
              })), o = u.flatMap((h) => h.symbol.symbolTable ? h.symbol.symbolTable : []);
            r.push(...u);
          }
          return r;
        },
  ...
  initMonacoServices() {
    return {
      definitionProvider: new Hr(this),
      referenceProvider: new Kr(this),
      autocompletionProvider: new $r(this)
    };
  }
}
export {
  c as CompileError,
  l as CompileErrorCode,
  uc as Compiler,
  P as ElementDeclarationNode,
  _ as ElementKind,
  ne as ProgramNode,
  D as ScopeKind,
  U as SyntaxNode,
  xe as SyntaxNodeKind,
  te as SyntaxToken,
  f as SyntaxTokenKind,
  lc as serialize,
  cc as services
};
